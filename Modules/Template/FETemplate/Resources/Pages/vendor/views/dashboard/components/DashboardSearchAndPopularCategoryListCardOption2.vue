<template>
    <div class="mt-2 w-full">
        <div class="bg-feAchromatic-900 relative">
            <div
                class="w-full h-[680px] sm:h-[680px] object-cover relative flex justify-center items-center"
            >
                <img
                    alt="Placeholder"
                    class="w-full opacity-60 h-[680px] sm:h-[680px] object-cover"
                    v-lazy="{
            ...
            >
                <div class="text-center">
                    <ps-label
                        ...
                        >{{ $t("home__banner_header") }}</ps-label
                    >
                    <ps-label
                ...
                <div
                    class="bg-feAchromatic-50 dark:bg-feSecondary-800 rounded-3xl px-4 py-4 sm:py-2 mx-auto"
                >
                ...
                <div class="">
                    ...
                    >
                    <div
                        class="flex justify-center flex-wrap gap-x-1 sm:gap-x-1 gap-y-1 popular-category"
                        v-if="popularCategoryStore.itemList?.data != null"
                    >
                        <div
                            v-for="category in popularCategoryStore.itemList.data.slice(
                                0,
                                6
                            )"
                            :key="category.catId"
                        ...
                        >
                            ...
                            >
                                <div
                                    class="text-center cursor-pointer w-26 overflow-hidden bg-feAchromatic-50 dark:bg-feSecondary-700 border border-feAchromatic-400 sm:rounded-md lg:rounded-md hover:bg-fePrimary-50 hover:border-fePrimary-500 hover:dark:bg-fePrimary-900"
                                >
                                    ...
                                    <ps-label
                                        class="text-sm pt-1 pb-4 font-normal"
                                        textColor="text-fePrimary-500"
                                    >
                                        {{
                                            $t(
                                                category.catName.length > 8
                                                    ? category.catName.slice(
                                                          0,
                                                          8
                                                      ) + "..."
                                                    : category.catName
