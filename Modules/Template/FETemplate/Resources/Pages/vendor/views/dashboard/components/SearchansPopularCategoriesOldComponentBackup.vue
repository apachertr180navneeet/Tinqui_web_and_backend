<template>
    <div class="mt-2 w-full top-banner">
        <div class="bg-feAchromatic-900 relative">
            <div
                class="w-full h-[530px] sm:h-[485px] object-cover relative flex justify-center items-center"
                id="sliderContainer"
            >
                ...
                <div class="pagination-dots">
                    ...
                    <span
                        class="dot"
                        :class="{ active: currentImageIndex == 3 }"
                    ></span>
                </div>
            </div>
            <!-- 
...
export default {
    ...
    setup(props) {
        ...
        function getImageTitle(currentImageIndex) {
            // const imagePathPrefix = "/storage/MPC/uploads/";
            return props.title[currentImageIndex];
        }
        function getImageContent(currentImageIndex) {
            // const imagePathPrefix = "/storage/MPC/uploads/";
            return props.content[currentImageIndex];
        }
        ...
        function updateImage(currentImageIndex) {
            ...
            const content = getImageContent(currentImageIndex);
            sliderTitle.value = title;
            sliderContent.value = content;
