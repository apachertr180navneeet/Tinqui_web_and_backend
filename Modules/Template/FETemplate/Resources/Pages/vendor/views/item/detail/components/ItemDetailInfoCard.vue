<template>
    <div
        ...
        v-if="
            productStore.item?.data?.productRelation.filter(
                (pr) => pr.coreKeysId == 'ps-itm00008'
            ).length != 0 &&
            productStore.item?.data?.productRelation.filter(
                (pr) => pr.coreKeysId == 'ps-itm00008'
            )[0]?.selectedValue[0]?.value != ''
        "
    >
        <ps-icon
        ...
        />
        <ps-label
            textColor="text-base font-semibold text-feSecondary-600 dark:text-feSecondary-50"
    ...
    <div
        class="bg-feSecondary-50 dark:bg-feSecondary-800 rounded-lg px-2 py-4 lg:p-4 mt-6"
    >
        <ps-label
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
            <div v-for="pr in productRelation" :key="pr.id" class="">
                <ps-label
                    ...
                    >{{
                        $t(
                            itemCustomFieldStore.customField.data?.customList.filter(
                                (cf) =>
                                    cf.coreKeysId == pr.coreKeysId &&
                                    cf.isVisible == "1"
                            )[0]?.name
                        )
                    }}</ps-label
                ...
                <ps-label
                    ...
                    >{{ $t(pr.selectedValue[0].value) }}</ps-label
                >
            </div>
            <div class="">
                <ps-label
                ...
                <ps-label
                    textColor="text-sm font-normal text-feSecondary-600 dark:text-feSecondary-200"
                    >{{
                        productStore.item?.data?.isSoldOut == "1"
                            ? $t("item_list__sold_item")
                            : $t("item_detail__available")
                    }}</ps-label
                >
            </div>
            <div class="">
                <ps-label
                    textColor="text-base font-medium text-feSecondary-800 dark:text-feSecondary-50"
                    >{{ $t("item_detail_publcation_date") }}</ps-label
                >
                <ps-label
                    textColor="text-sm font-normal text-feSecondary-600 dark:text-feSecondary-200"
                    >{{ productStore.item?.data?.addedDateStr }}</ps-label
                >
            </div>
        </div>
    </div>
    ...
    <!-- description -->
    <div
        class="mt-6 px-2 py-4 lg:p-4 rounded-lg bg-feSecondary-50 dark:bg-feSecondary-800"
    >
        <ps-label
            textColor="text-xl font-semibold text-feSecondary-800 dark:text-feSecondary-50"
        ...
        <div class="mt-6">
            ...
            >
                {{
                    productStore.item?.data
                        ? productStore.item?.data?.description
                        : ""
                }}
            </ps-label>
        </div>
    ...
    <div
        v-if="
            (productStore.item?.data?.productRelation.filter(
                (pr) =>
                    pr.coreKeysId == 'ps-itm-rpt00005' ||
                    pr.coreKeysId == 'ps-itm00003'
            ).lenght != 0 &&
                productStore.item?.data?.productRelation.filter(
                    (pr) =>
                        pr.coreKeysId == 'ps-itm-rpt00005' ||
            ...
            (productStore.item?.data?.productRelation.filter(
                (pr) =>
                    pr.coreKeysId != 'ps-itm-rpt00005' &&
                    pr.coreKeysId != 'ps-itm00003' &&
                    pr.coreKeysId != 'ps-itm00002' &&
                    pr.coreKeysId != 'ps-itm00004' &&
                    pr.coreKeysId != 'ps-itm00007' &&
                    pr.coreKeysId != 'ps-itm00008' &&
                    pr.coreKeysId != 'ps-itm00009'
            ).length != 0 &&
                productStore.item?.data?.productRelation.filter(
                    (pr) =>
                        pr.coreKeysId != 'ps-itm-rpt00005' &&
            ...
            (productStore.item?.data?.phone != null &&
                productStore.item?.data?.phone != '')
        "
    >
        <div class="col-span-8 mt-6">
            ...
            >
                ...
                <div
                    v-for="productRelation in productStore.item?.data?.productRelation.filter(
                        (pr) =>
                            pr.coreKeysId != 'ps-itm00002' &&
                            pr.coreKeysId != 'ps-itm00004' &&
                            pr.coreKeysId != 'ps-itm00007'
                    ...
                    :key="productRelation.id"
                >
                    <div v-if="productRelation.isVisible == '1' && productRelation.coreKeyName.toLowerCase() !=='item address'">
                        <ps-label
                ...
                >
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <div
                            v-for="(
                                phone, index
                            ) in productStore.item?.data.phone.split('#')"
                            :key="index"
                        >
                            <ps-label
                                textColor="text-sm font-normal text-feSecondary-600 dark:text-feSecondary-200 mt-2"
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            const addedDate = new Date(productStore.item?.data?.addedDate);
            const months = [
                "January",
                "February",
                "March",
            ...
            const month = months[addedDate.getMonth()];
