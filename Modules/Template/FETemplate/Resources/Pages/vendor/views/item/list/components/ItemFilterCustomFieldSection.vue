<template>
    <div
        v-for="customFieldHeader in customFieldStore.customField.data
            ?.customList"
    ...
    >
        ...
        <div
            class="mt-6"
            v-if="
                (customFieldHeader.coreKeysId == 'ps-itm00007' ||
                    customFieldHeader.coreKeysId == 'ps-itm00002') &&
                customFieldHeader.uiType.coreKeysId === 'uit00001' &&
                customFieldHeader.isVisible === '1' &&
                customFieldHeader.isDelete === '0'
            "
        >
            <ps-label class="mb-1 text-base">{{
                    ...
                    <div class="rounded-md shadow-xs w-56">
                        <div class="pt-2 z-30">
                                ...
                                v-if="
                                    customizeUiStoreList.data.filter(
                                        (customizeDetail) =>
                                            customizeDetail.id ===
                                            customFieldHeader.coreKeysId
                                    )[0]?.provider?.customizeUiList.data == null
                                "
                            >
                                <ps-label
                                    class="p-2 flex"
                            ...
                            <div v-else>
                                ...
                                <div
                                    v-for="selectData in customizeUiStoreList.data.filter(
                                        (customizeDetail) =>
                                            customizeDetail.id ===
                                            customFieldHeader.coreKeysId
                ...
                <template #loadmore>
                    <div class="mb-2 w-56">
                        ...
                        <ps-label
                            ...
                            "
                            @click="
                                loadCustomField(customFieldHeader.coreKeysId)
                            "
                        >
