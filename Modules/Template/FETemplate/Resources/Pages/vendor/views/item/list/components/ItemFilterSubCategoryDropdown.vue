<template>
    ...
    <ps-dropdown
        ...
        @click="loadSubCategory(itemProvider.paramHolder.catId)"
    >
        <template #select>
            <ps-dropdown-select
                placeholderLang="item_list__all"
                border="border dark:border-feSecondary-200"
                :selectedValue="$t(itemProvider.paramHolder.subCatName)"
            />
        </template>
        <template #filter>
            <div class="w-56">
            ...
            <div class="rounded-md shadow-xs w-56">
                <div class="pt-2 z-30">
                    ...
                    <div v-else>
                        ...
                        <div
                            v-for="selectSubCat in subCategoryStore
            ...
            <div class="mb-2 w-56">
                <div
                    v-if="
                        ...
                        subCategoryStore.loading.value == true
                    "
                ...
                <ps-label
                    v-if="
                        ...
                        !subCategoryStore.isNoMoreRecord
                    "
