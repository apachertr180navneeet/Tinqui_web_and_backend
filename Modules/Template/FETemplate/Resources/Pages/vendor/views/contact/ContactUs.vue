<template>
    ...
    <ps-content-container>
        <template #content>
            <div
                class="bg-feAchromatic-50 dark:bg-feAchromatic-900 rounded-lg w-auto sm:w-[556px] sm:mt-32 lg:mt-36 mt-28 mb-16 mx-auto py-4"
            >
                <div class="flex justify-center items-center">
                    <ps-label-header-4 class="mb-4 font-medium">
                        {{ $t("contact_us__contact_us") }}
                    </ps-label-header-4>
                </div>
                <div class="w-full flex flex-col">
                    <div class="px-10">
                        <ps-label class="mt-4">
                            {{ $t("contact_us__contact_name") }}
                            <span style="font-size: 17px; color: red">*</span>
                        </ps-label>
                        <ps-input
                            class="mt-2"
                            type="text"
                            v-bind:placeholder="$t('contact_us__contact_name')"
                            v-model:value="name"
                        ></ps-input>
                        <ps-label
                            class="mt-4"
                            textColor="text-fePrimary-500"
                            v-if="validation.nameStatus"
                        >
                            {{ $t("contact_us__name_required_error") }}
                        </ps-label>
                    </div>

                    <div class="px-10">
                        <ps-label class="mt-4">
                            {{ $t("contact_us__contact_phone") }}
                            <span style="font-size: 17px; color: red">*</span>
                        </ps-label>
                        <ps-input
                            class="mt-2"
                            type="text"
                            v-bind:placeholder="$t('contact_us__contact_phone')"
                            v-model:value="phone"
                        ...
                        <ps-label
                            class="mt-4"
                            textColor="text-fePrimary-500"
                            v-if="validation.phoneStatus"
                        >
                            {{ $t("contact_us__phone_required_error") }}
                        </ps-label>
                    </div>
                    ...
                    <div class="px-10">
                        ...
                        <ps-input
                            class="mt-2"
                            type="email"
                            v-bind:placeholder="$t('contact_us__contact_email')"
                            v-model:value="email"
                        ...
                        <ps-label
                            class="mt-4"
                            textColor="text-fePrimary-500"
                            v-if="validation.emailStatus"
                        >
                            {{ $t("contact_us__email_required_error") }}
                        </ps-label>
                    </div>
                    ...
                    <div class="px-10">
                        ...
                        <ps-label
                            class="mt-4"
                            textColor="text-fePrimary-500"
                            v-if="validation.messageStatus"
                        >
                            {{ $t("contact_us__message_required_error") }}
                        </ps-label>
                    </div>

                    <div class="flex flex-col items-center mx-8 mb-4">
                        <ps-button
                            class="mt-6 sm:w-auto"
                            @click="submitclicked"
                            :disabled="false"
                        >
    ...
    setup() {
        ...
        async function submitclicked() {
            ...
            ps_success_dialog.value.openModal(
                "Success!",
                trans("contact_us__add_successed")
            );
