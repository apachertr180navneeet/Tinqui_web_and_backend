<template>
    ...
    <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 px-5 xl:px-52 mx-auto">
        <div
            class="grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4 gap-4 sm:gap-3.5 lg:gap-10"
        >
            ...
            <div class="col-start-0 col-span-4 sm:col-span-2 lg:col-span-3">
                ...
                <div class=" ">
                    ...
                    >
                        ...
                        <ps-button
                            class="w-full"
                            colors="bg-feAchromatic-50 dark_bg-feAchromatic-800 dark_text-feAchromatic-200 hover_text-feAchromatic-50"
                            border="border border-feAchromatic-300 dark_border-feAchromatic-500"
                            rounded="rounded"
                            @click="sellerClicked"
                        >
                            <span class="me-2 md:me-4">{{
            ...
            <div class="col-span-4 sm:col-span-6 lg:col-span-9">
                ...
                <div class="col-span-4 sm:col-span-6 lg:col-span-9 mb-2" v-else>
                    ...
                    <ps-label class="text-sm sm:text-xl font-medium">
                        {{ $t("offer_list__offer_sent") }}</ps-label
                    >
                </div>
                <div v-if="ps_loading">
                    <div
                ...
                <div
                    id="seller"
                    class="flex flex-row mb-16"
                    v-if="isSellerFocus && ps_loading == false"
                >
                    <div
                        v-if="offerListProvider.offerList.data == null"
                        class="w-full flex flex-col bg-fePrimary-50 dark_bg-feAchromatic-800 lg:p-4 p-2 sm:p-3 rounded-2xl"
                    >
                        <ps-icon
                            name="mailOpen"
                            textColor="text-feSecondary-400 dark_text-feAchromatic-500"
                            class="mt-2 w-full mx-auto"
                            w="80"
                            h="80"
                        />
                        <ps-label-caption-3 class="text-center mb-2">
                            {{ $t("offer_list__nothing_in_offer_received") }}
                        </ps-label-caption-3>
                    </div>
                    <div
                        v-else
                    ...
                    >
                        <div class="flex flex-wrap">
                            ...
                            <div
                                class="mt-2 w-full"
                                v-for="chathistory in offerListProvider
                                    .offerList.data"
                                :key="chathistory.id"
                            >
                                <ps-route-link
                                    :to="{
                                        ...
                                        query: {
                                            buyer_user_id:
                                                chathistory.buyerUserId,
                                            seller_user_id:
                                                chathistory.sellerUserId,
                                            item_name: chathistory.item.title,
                                            item_id: chathistory.itemId,
                                            item_image_name:
                                                chathistory.item.defaultPhoto
                                                    .imgPath,
                                            item_price: chathistory.item.price,
                                            currency:
                                                chathistory.item.itemCurrency
                                                    .currencySymbol,
                                            chat_flag:
                                                PsConst.CHAT_FROM_SELLER.toString(),
                                            is_sold_out:
                                                chathistory.item.isSoldOut,
                                        },
                                    }"
                                >
                                    <!-- <chat-horizontal-item  :chathistory="chathistory" /> -->
                                    <offer-horizontal-item
                ...
                <div
                    id="buyer"
                    class="flex flex-row mb-16"
                    v-else-if="ps_loading == false"
                >
                    <div
                        v-if="offerReceivedListProvider.offerList.data == null"
                        class="w-full flex flex-col bg-fePrimary-50 dark_bg-feAchromatic-800 lg:p-4 p-2 sm:p-3 rounded-2xl"
                    >
                        <ps-icon
                            name="mailOpen"
                        ...
                        />
                        <ps-label-caption-3 class="text-center mb-2">{{
                            $t("offer_list__nothing_in_offer_sent")
                        }}</ps-label-caption-3>
                    </div>
                    <div v-else class="w-full">
                        ...
                        >
                            <!-- Column -->
                            <div
                                class="w-full mt-2 offer_list"
                                v-for="chathistory in offerReceivedListProvider
                                    .offerList.data"
                                :key="chathistory.id"
                            >
                                <ps-route-link
                                        ...
                                        query: {
                                            ...
                                            currency:
                                                chathistory.item.itemCurrency
                                                    .currencySymbol,
                                            chat_flag:
                                                PsConst.CHAT_FROM_BUYER.toString(),
                                            is_sold_out:
                                                chathistory.item.isSoldOut,
                                        },
                                    }"
