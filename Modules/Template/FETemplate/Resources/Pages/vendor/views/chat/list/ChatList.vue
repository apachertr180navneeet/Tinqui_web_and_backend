<template>
    ...
    <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 px-5 xl:px-52 mx-auto">
        <div class="grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-10 ">
            ...
            <div class="col-start-0 col-span-4 sm:col-span-2 lg:col-span-3 dispute-page" >
                ...
                <div>
                    <div class=" flex flex-row rtl:space-x-reverse space-x-2 sm:space-x-0 space-y-0 sm:space-y-2 sm:flex-col" id="sellerbtn" v-if="!isSellerFocus" :disabled="true">
                        <ps-button class="w-full" @click="buyerClicked" >
                            ...
                            <span v-if=" userunreadmsgStore.unreadCount.data?.sellerUnreadCount?.toString() != '0'" class="rounded-full w-8 float-right bg-fePrimary-500 text-feAchromatic-50">{{ userunreadmsgStore.unreadCount.data?.sellerUnreadCount}}</span>
                        </ps-button>
                        ...
                        <ps-button class="w-full" colors="bg-feAchromatic-50 dark:bg-feAchromatic-800 dark:text-feAchromatic-200 hover:text-feAchromatic-50" border="border border-feAchromatic-300 dark:border-feAchromatic-500" rounded="rounded" @click="sellerClicked">
                            ...
                            <span v-if=" userunreadmsgStore.unreadCount.data?.buyerUnreadCount?.toString() != '0'" class="rounded-full w-8 float-right bg-fePrimary-500 text-feAchromatic-50">{{ userunreadmsgStore.unreadCount.data?.buyerUnreadCount}}</span>
                        </ps-button>
                    </div>
