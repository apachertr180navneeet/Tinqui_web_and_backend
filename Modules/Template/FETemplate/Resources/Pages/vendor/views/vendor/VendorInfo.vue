            ...
            <div class="mt-32 mb-10">
                ...
                <div class="rounded-lg border dark:border-feAchromatic-800 dark:bg-feAchromatic-800 overflow-hidden">
                    ...
                    <div class="flex sm:flex-row flex-col items-center gap-4 sm:gap-6 px-6 py-4">
                        <img class="w-20 h-20 rounded-full object-cover" v-lazy="{ src: $page.props.uploadUrl + '/' + vendorStore.vendor.data?.logo?.imgPath, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }" alt="">
                ...
                <div v-if="isProfile" class="mt-6">
                    ...
                    <div class="px-6 py-8 flex flex-col items-center sm:flex-row sm:items-start gap-6 mt-4 border dark:border-feAchromatic-800 dark:bg-feAchromatic-800 rounded-lg">
                        <img class="w-20 h-20 rounded-full" v-lazy="{ src: $page.props.uploadUrl + '/' + vendorStore.vendor.data?.logo?.imgPath, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }" alt="">
                        <div class="">
