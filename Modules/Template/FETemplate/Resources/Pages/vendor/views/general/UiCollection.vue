    ...
    <ps-content-container>
        <template #content>
            <div class="flex flex-col mt-36">
                ...
                <ps-label-caption>{{
                    $t("ui_collection___label_caption")
                }}</ps-label-caption>
                <ps-label-caption-2>{{
                ...
                <ps-input
                    class="mb-2"
                    v-bind:placeholder="$t('ui_collection__email')"
                ></ps-input>
                ...
                <ps-input-with-right-icon
                    class="mt-2"
                    v-bind:placeholder="
                        $t('ui_collection__what_are_you_looking_for')
                    "
                >
                    <template #icon>
                ...
                >
                    <template #leftButton>
                        <ps-dropdown>
                            <template #select>
                                <ps-dropdown-select
                                    border="border border-e-feSecondary-200"
                                    rounded="rounded-l"
                            ...
                            <template #list>
                                ...
                                >
                                    ...
                                    <div
                                        class="border-t border-feAchromatic-100"
                                    ></div>
                                </div>
                            </template>
                        </ps-dropdown>
                ...
                <div class="flex flex-row rtl:space-x-reverse space-x-4 mb-4">
                    <ps-button class="mt-2 w-">
                        {{ $t("ui_collection__primary_button") }}
                    </ps-button>
                    <ps-button class="mt-2" :disabled="true">
                        {{ $t("ui_collection__disabled_button") }}
                    </ps-button>
                </div>
                ...
                <div class="flex flex-row rtl:space-x-reverse space-x-4 mb-4">
                    <ps-feSecondary-button class="mt-2">
                        {{ $t("ui_collection__primary_button") }}
                    </ps-feSecondary-button>
                    <ps-feSecondary-button class="mt-2" :disabled="true">
                        {{ $t("ui_collection__disabled_button") }}
                    </ps-feSecondary-button>
                </div>
                ...
                <div class="flex flex-row rtl:space-x-reverse space-x-4 mb-4">
                    <ps-text-button class="mt-2">
                        {{ $t("ui_collection__primary_button") }}
                    </ps-text-button>
                    <ps-text-button class="mt-2" :disabled="true">
                        {{ $t("ui_collection__disabled_button") }}
                    </ps-text-button>
                </div>
                ...
                <div class="flex items-center mt-4">
                    <ps-checkbox-value
                        ...
                        v-bind:title="$t('ui_collection__apple')"
                        class="me-4"
                    />
                    <ps-checkbox-value
                        v-model:value="checkedFruits.ornage"
                        v-bind:title="$t('ui_collection__orange')"
                        class="me-4"
                    />
                    <ps-checkbox-value
                        v-model:value="checkedFruits.grape"
                        v-bind:title="$t('ui_collection__grape')"
                        class="me-4"
                    />
                </div>
                ...
                <ps-checkbox
                    v-for="selectData in checkedDataList"
                    :key="selectData.id"
                    :value="selectData"
                    v-model:selectedValue="checkedSelectedList"
                    :title="selectData.name"
                    class="focus:bg-fePrimary-500 dark:bg-feAccent-500"
                >
                    {{ selectData.name }}
                </ps-checkbox>
                ...
                <div class="flex items-center mt-4" id="r1">
                    ...
                    <ps-radio-value
                        v-model:value="radioFruits"
                        v-bind:title="$t('ui_collection__mango')"
                        class="me-4"
                    />
                </div>
                ...
                <div class="flex items-center mt-4" id="r1">
                    <ps-radio
                        ...
                        :title="selectData.name"
                        class="focus:bg-fePrimary-500 dark:bg-feAccent-500 me-4"
                    ></ps-radio>
                </div>
                            ...
                            >
                                <div class="pt-2">
                                    <div
                                        v-for="i in 5"
                                        :key="i"
                                        class="flex py-4 px-2 hover:bg-fePrimary-50 dark:hover:bg-feSecondary-500 cursor-pointer items-center"
                                        @click="onItemClick(i)"
                                    >
                                        <img
                                            width="300px"
                                        ...
                                        />
                                        <span
                                            class="ms-2 text-feSecondary-800 dark:text-feSecondary-200"
                                            :class="
                                                i == selectedIndex
                                                    ? 'font-semibold'
                                                    : ''
                ...
                <div class="flex flex-wrap rtl:space-x-reverse space-x-2 mt-4">
                    ...
                    <ps-button
                        @click="dangerClicked"
                        colors="bg-fePrimary-500 text-feAchromatic-50"
                        hover="hover:outline-none hover:ring hover:ring-fePrimary-500-100"
                        focus="focus:outline-none focus:ring focus:ring-fePrimary-500-300"
                        >Danger</ps-button
                    >
                    <ps-button
                        @click="warningClicked"
                        colors="bg-feWarning-500 text-feAchromatic-50"
                        >Warning</ps-button
                    >
                ...
                <div class="flex flex-wrap rtl:space-x-reverse space-x-2 mt-4">
                    <ps-button
                        ...
                        hover="hover:outline-none hover:ring hover:ring-feSuccess-100"
                        focus="focus:outline-none focus:ring focus:ring-feSuccess-300"
                        >Success</ps-button
                    >
                    <ps-button
                        @click="errorClicked"
...
export default defineComponent({
    ...
    setup() {
        ...
        function speak() {
            greetingSpeech.text =
                "Hello! Welcome from Tinqui. Your bidding is going to finish. 5, 4, 3, 2, 1. bidding completed. Thanks for using our service.";
