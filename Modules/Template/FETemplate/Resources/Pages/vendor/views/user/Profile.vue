<template>
    ...
    <ps-content-container>
        <template #content>
            ...
            <div
                class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-5 md:gap-6 pb-12"
            >
                <!-- profile card -->
                <profile-info-card />
                ...
                <div class="w-full sm:col-span-2 lg:col-span-2 xl:col-span-3">
                    ...
                    <!-- vendor list -->
                    <profile-vendor-horizontal-list
                        v-if="appInfoStore?.isVendorSettingOn()"
                    />

                    <!-- Start Purchased Package -->
                    <profile-purchased-package-horizontal-list
                        v-if="appInfoStore?.isPaidAppOn()"
                    />
