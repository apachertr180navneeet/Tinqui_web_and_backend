    ...
    <div>
        <div class="sm:mt-32 lg:mt-36 mt-28 flex flex-col">
            <div class="content-center mx-auto w-96">
                <ps-label
                    class="content-center text-general-200 dark:text-feAchromatic-50 px-4 py-4 rounded-md"
            ...
            <div class="w-55 lg:w-80 flex flex-col mx-auto rounded-lg">
                ...
                >
                    {{ $t("login__login_title") }}
                </ps-label>
                <!-- <form class="flex flex-col"> -->
                <!-- Login Entry -->
                <ps-label class="mt-4 lg:mt-5 font-medium text-base lg:text-xl">
                    {{ $t("login__email") }}
                </ps-label>
                <ps-input
                    class="lg:mt-2 mt-1"
                    type="email"
                    v-bind:placeholder="$t('login__email_placeholder')"
                    v-on:keyup.enter="normalLoginClicked"
                    v-model:value="email"
                ...
                <ps-input
                    class="lg:mt-2 mt-1"
                    type="password"
                    v-bind:placeholder="$t('login__password_placeholder')"
                    v-on:keyup.enter="normalLoginClicked"
                ...
                <div class="mt-4 lg:mt-5 flex flex-col items-center">
                    ...
                    <ps-label
                        textColor="text-feSecondary-400 dark:text-feAchromatic-500"
                        class="cursor-pointer mt-3 font-light text-xs lg:text-sm"
                        @click="openRegister"
                    >
                        {{ $t("login__new_here") }}
                        <span class="font-medium">
                            {{ $t("login__sign_up") }}</span
                        >
                    </ps-label>
                </div>
