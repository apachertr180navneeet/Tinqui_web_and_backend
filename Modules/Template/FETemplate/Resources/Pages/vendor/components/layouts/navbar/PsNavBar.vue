<template>
    <nav
        class="menu-bar flex flex-col fixed w-full h-16 z-40 bg-feAchromatic-50 dark:bg-feAchromatic-900 shadow"
        :class="topOfPage ? 'mt-10' : 'mt-0'"
    >
        <div
            class="lg:w-large xl:w-feLarge mx-4 md:mx-6 lg:mx-auto flex items-center justify-between mt-3"
        >
            <div class="md:flex gap-5 hidden">
                    ...
                    <img
                        v-lazy="{
                            src:
                                ...
                                '/' +
                                appInfoStore.appInfo.data?.frontendConfigSetting
                                    ?.frontendLogo?.imgPath,
                            loading:
                                $page.props.sysImageUrl + '/loading_gif.gif',
                            error:
                ...
                <ps-route-link
                    ...
                    :textColor="
                        currentPage === 'dashboard'
                            ? 'text-fePrimary-500'
                            : 'text-feSecondary-800 dark:text-feAchromatic-50'
                    "
                    class="menulink px-4 py-2"
                >
                    {{ $t("ps_nav_bar__home") }}
                </ps-route-link>
                <!-- <ps-route-link
                ...
                <ps-route-link
                    :to="{ name: 'fe_contact_us' }"
                    textSize="text-sm hover:text-fePrimary-500 hover:dark:text-fePrimary-500 font-medium cursor-pointer"
                    :textColor="
                        currentPage === 'fe_contact_us'
                            ? 'text-fePrimary-500'
                            : 'text-feSecondary-800 dark:text-feAchromatic-50'
                    "
                    class="px-2 py-2"
            ...
            >
                <ps-icon
                    ...
                    textColor="text-feSecondary-800 dark:text-feAchromatic-50"
                    name="menu"
                    h="24"
                    w="24"
                />
            </div>
            <div class="flex gap-6 items-center custom-search">
                <ps-icon
                    v-if="$page.props.authUser != null"
                    class="cursor-pointer search-input"
                ...
                <div
                    v-if="$page.props.authUser == null"
                    class="desktop-search testcate bg-feAchromatic-50 dark:bg-feSecondary-800 rounded-lg px-4 py-4 sm:py-2 mx-auto"
                    style="padding-top: 0"
                >
                ...
                >
                    <ps-route-link :to="{ name: 'fe_chat_list' }">
                        <div class="relative">
                            ...
                            />
                            <div
                                class="me-6 p-0.5 text-xs font-semibold rounded-full bg-fePrimary-500 text-feAchromatic-50 absolute -top-2 -right-8"
                                v-if="
                                    parseInt(
                                        userunreadmsgStore.unreadCount.data
                                            ?.buyerUnreadCount
                                    ) +
                                    parseInt(
                                        userunreadmsgStore.unreadCount.data
                            ...
                            >
                                {{
                                    ...
                                    parseInt(
                                        ...
                                        ? parseInt(
                                              userunreadmsgStore.unreadCount
                    ...
                    <ps-dropdown
                        ...
                        class="ms-3 sm:ms-4 lg:ms-6 xxl:ms-8 w-full profile-popup"
                        h="h-auto"
                            ...
                            <div class="rounded-md shadow-xs w-[280px]">
                                <div class="z-30">
                                    ...
                                    >
                                        ...
                                        />
                                        <ps-label class="ms-2">{{
                                            $t("core__fe_favourites")
                                        }}</ps-label>
                                    </ps-route-link>

                                    <ps-route-link
                                        :to="{ name: 'fe_offer_list' }"
                                        textSize="text-sm"
                                    ...
                                    <ps-route-link
                                        ...
                                        class="w-full flex p-4 hover:bg-fePrimary-50 dark:hover:bg-fePrimary-900 cursor-pointer items-center"
                                    >
                                        <ps-icon name="wallet" class="ms-2" />
                                        <ps-label class="ms-2">{{
                                            $t("profile__user_wallet")
                                        }}</ps-label>
                                    </ps-route-link>
                                    ...
                                    <ps-route-link
                                        ...
                                        class="w-full flex p-4 hover:bg-fePrimary-50 dark:hover:bg-fePrimary-900 cursor-pointer items-center"
                                    >
                                        <ps-icon name="setting" class="ms-2" />
                                        <ps-label class="ms-2">{{
                                            $t("stripe_connect_account")
                                        }}</ps-label>
                                    </ps-route-link>
                                    ...
                                    >
                                        <ps-icon name="wallet" class="ms-2" />
                                        <ps-label class="ms-2">{{
                                            $t("profile__user_disputes")
                                        }}</ps-label>
                                    </ps-route-link>

                                    <ps-route-link
                                        :to="{ name: 'fe_sales_purchase' }"
                                        textSize="text-sm"
                                        class="w-full flex p-4 hover:bg-fePrimary-50 dark:hover:bg-fePrimary-900 cursor-pointer items-center"
                                    >
                                        <ps-icon name="wallet" class="ms-2" />
                                        <ps-label class="ms-2 capitalize">{{
                                            $t("sales_purchase_section")
                                        }}</ps-label>
                                    </ps-route-link>
                                    <ps-route-link
                                        :to="{ name: 'fe_my_bids' }"
                                    ...
                                    <ps-route-link
                                        v-if="
                                            $page.props.canAccessVendor &&
                                            appInfoStore?.isVendorSettingOn()
                                        "
                                        :to="{ name: 'vendor.setSession' }"
                                        textSize="text-sm"
                                        class="w-full flex p-4 hover:bg-fePrimary-50 dark:hover:bg-fePrimary-900 cursor-pointer items-center"
                                    >
                                        <ps-icon name="refresh" class="ms-2" />
                                        <ps-label class="ms-2">{{
                                            $t("core__fe_switch_to_vendor")
                                        }}</ps-label>
                                    </ps-route-link>
                                    <ps-route-link
                                        v-if="$page.props.canAccessAdminPanel"
                                        :to="{ name: 'admin.index' }"
                                        textSize="text-sm"
                                        class="w-full flex p-4 hover:bg-fePrimary-50 dark:hover:bg-fePrimary-900 cursor-pointer items-center"
                                    >
                ...
                <div
                    ...
                    v-if="submitButtonShow == true"
                >
                    <ps-route-link
                        :to="{
                            name:
                                $page.props.authUser != null
                                    ? 'fe_item_entry'
                                    : 'login',
                        }"
                    >
                        <ps-button
                            padding="lg:px-4 lg:py-2 p-2"
                            class="blink text-deco"
                        >
                            <ps-icon
                                name="plus-circle"
                                class="me-0 lg:me-2"
        ...
        <transition>
            ...
            >
                        ...
                        <img
                            v-lazy="{
                                src:
                                    ...
                                    '/' +
                                    $page.props.backendLogo.img_path,
                                loading:
                                    $page.props.sysImageUrl +
                                    '/loading_gif.gif',
                                error:
                ...
                <div
                    v-if="$page.props.authUser == null"
                    class="testcate bg-feAchromatic-50 dark:bg-feSecondary-800 rounded-lg px-4 py-4 sm:py-2 mx-auto"
                    style="padding-top: 0"
                >
                    <search-for-large-screem />
                </div>
...
import SearchForLargeScreem from "@template1/vendor/views/search/SearchTopBar.vue";

import { trans } from "laravel-vue-i18n";

const UserSettingModal = defineAsyncComponent(() =>
    import("@template1/vendor/components/modules/user/UserSettingModal.vue")
);
const SearchModal = defineAsyncComponent(() =>
    import("@template1/vendor/components/modules/search/SearchModal.vue")
);
...
export default defineComponent({
    ...
    setup() {
        ...
        async function loadMessage() {
            if (holder.userId != null && holder.userId != "nologinuser") {
        ...
        /*********hide Submit Add button for item-entry and login  route*****/
        // function hideSubbmitAdButton() {
        //     if (currentPage == route("login")) {
        ...
        async function isSubmitButtonShow() {
            ...
            if (loginUserId != "nologinuser") {
                ...
                const roleId = (await userProvider.user.data)
                    ? userProvider.user.data.roleId
                    : "";
                const isVerifybluemark = (await userProvider.user.data)
                    ? userProvider.user.data.isVerifybluemark
                    : "";
                ...
                if (
                    appInfoStore.appInfo.data?.uploadSetting == "admin-bluemark"
                ) {
                ...
                window.location.pathname.includes("go-live") ||
                window.location.pathname.includes("auction-view")
            ) {
                submitButtonShow.value = false;
            } else {
                submitButtonShow.value = true;
...
.floating-button-container {
    position: fixed;
    bottom: 56px; /* Adjust this value to change the distance from the bottom */
    right: 66px; /* Adjust this value to change the distance from the right */
