<template>
    <ps-modal
        ...
        :isClickOut="false"
        maxWidth="472px"
        theme="rounded-lg p-6 bg-feAchromatic-50 dark:bg-feSecondary-800"
    >
        <template #title>
            <ps-label
                textColor="text-xl font-semibold text-feSecondary-800 dark:text-feSecondary-200"
            >
                {{ $t("share_with_social_modal__share_with") }}
            </ps-label>
        </template>
        <template #body>
            <ps-link :url="facebookURL">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <ps-label
                        textColor="text-lg font-medium text-feSecondary-800 dark:text-feSecondary-200"
                    >
                        {{ $t("Facebook") }}
                    </ps-label>
                </div>
        ...
        <template #footer>
            <div class="flex justify-end">
                <ps-button
                    ...
                    hover="dark:hover:bg-feSecondary-700"
                    border="border"
                >
                    {{ $t("share_with_social_modal__cancel") }}
                </ps-button>
            </div>
        </template>
    </ps-modal>
