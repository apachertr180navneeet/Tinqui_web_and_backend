<template>
    <ps-modal ref="psmodal" theme="p-0 rounded-2xl dark:bg-feSecondary-800" line="hidden" bodyHeight="max-h-108" maxWidth="800px" :isClickOut='false' class=" z-50 out_modell" >
        <template #title>
            <ps-label class="font-semibold sm:text-2xl text-xl py-3 px-3 settings-tittle" > {{ $t("profile__user_setting") }} </ps-label>
