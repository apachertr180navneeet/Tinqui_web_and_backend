<template>
    <ps-modal
        ...
        maxWidth="552px"
        bodyHeight="h-[500px]"
        theme="rounded-lg px-8 py-6 bg-feAchromatic-50 dark:bg-feSecondary-800 custom-padding"
    >
        <template #title>
            <div class="flex justify-between items-center">
                <ps-label
                    textColor="text-lg font-semibold text-feSecondary-800 dark:text-feSecondary-200"
                >
                    {{ $t("core_fe__find_what_you_need") }}
                </ps-label>
                <ps-icon
                    name="close"
                    class="text-feAchromatic-400 hover:cursor-pointer"
                    w="24"
                    h="24"
        ...
        <template #body>
            <div class="relative">
                <div
                    class="w-full h-full bg-feAchromatic-50 dark:bg-feSecondary-800 absolute z-20"
                    v-if="isShow"
                >
                    <div class="grid grid-cols-3">
                        <div class="col-span-1">
                            <ps-label
                                textColor="text-sm font-medium text-fePrimary-500 px-2 py-1 cursor-pointer"
                                @click="hideRecentSearch()"
                                >{{ $t("core_fe__back") }}</ps-label
                            >
                        </div>
                        <div class="col-span-1 text-center">
                            <ps-label
                                textColor="text-lg font-semibold text-feSecondary-800 dark:text-feSecondary-200"
                                >{{ $t(recentHistoryTitle) }}</ps-label
                            >
                        </div>
                    </div>
                    <div class="border-b-2 pb-1 mt-6">
                        <ps-label
                            textColor="text-xs font-medium text-feSecondary-500 px-2 py-1 cursor-pointer"
                            @click="deleteHistory()"
                            >{{ $t("core_fe__clear_searches") }}</ps-label
                        >
                    </div>
                    <div
                        v-if="loading"
                        class="mt-3 flex items-center justify-center h-96"
                    >
                        <ps-label
                            textColor="text-sm font-normal text-feSecondary-800 dark:text-feSecondary-200"
                            >{{ $t("list__loading") }}</ps-label
                        >
                    </div>
                    <div
                        v-else
                        class="mt-3 flex flex-col gap-4 h-96 overflow-auto"
                    >
                        <div
                            v-for="history in currentHistoryList
                                .searchHistoryList?.data"
                            :key="history.id"
                        >
                            <ps-label
                                textColor="text-sm font-normal text-feSecondary-800 dark:text-feSecondary-200"
                                >{{ history.keyword }}</ps-label
                            >
                        </div>
                    </div>
                </div>

                <div class="flex gap-1 mt-4 dark:text-feAchromatic-50 custom-tab">
                    <div
                        :class="[
                            'flex items-center gap-2 p-2 cursor-pointer border-b-4',
                            activeTabId == '0'
                                ? 'border-fePrimary-500'
                                : 'border-feAchromatic-50 dark:border-feSecondary-800',
                        ]"
                        @click="setActiveTabId('0')"
                    >
                        <ps-label
                            :textColor="
                                activeTabId == '0' ? 'font-semibold' : ''
                            "
                            >{{ $t("core_fe__all") }}</ps-label
                        >
                    </div>
                    <div
                        :class="[
                    ...
                    >
                        ...
                        <ps-label
                            :textColor="
                                activeTabId == '1' ? 'font-semibold' : ''
                            "
                            >{{ $t("core_fe__search_item") }}</ps-label
                        >
                    </div>
                    <div
                        :class="[
                    ...
                    >
                        ...
                        <ps-label
                            :textColor="
                                activeTabId == '2' ? 'font-semibold' : ''
                            "
                            >{{ $t("item_entry__category") }}</ps-label
                        >
                    </div>
                    <div
                        :class="[
                        ...
                        @click="setActiveTabId('3')"
                    >
                        <ps-icon name="user" w="24" h="24" />
                        <ps-label
                            :textColor="
                                activeTabId == '3' ? 'font-semibold' : ''
                            "
                            >{{ $t("core_fe__user") }}</ps-label
                        >
                    </div>
                </div>
                <div class="mt-2">
                    <ps-input-with-left-icon
                        ...
                        v-model:value="allSearchHolder.keyword"
                    >
                        <template #icon>
                            <ps-icon
                                name="search"
                                textColor="text-feSecondary-800 dark:text-feSecondary-400"
                                w="24"
                                h="24"
                            />
                        </template>
                ...
                <div class="mt-6">
                    ...
                    >
                        <div v-if="loginUserId != PsConst.NO_LOGIN_USER">
                            ...
                            <div
                                v-if="
                                    allSearchHistroyStore.searchHistoryList
                                        ?.data != null
                                "
                            >
                                <div class="flex justify-between border-b pb-2">
                                    <ps-label
                                        textColor="text-base font-medium text-feSecondary-500"
                                        >{{
                                            $t("core_fe__recent_searches")
                                        }}</ps-label
                                    >
                                    <ps-label
                                        textColor="text-base font-medium text-feSecondary-500 cursor-pointer"
                                        @click="showRecentSearch('all')"
                                        >{{ $t("core_fe__see_all") }}</ps-label
                                    >
                                </div>
                                <div
                                    class="mt-3 flex flex-col gap-4 max-h-80 overflow-auto"
                                >
                                    <div
                                        v-for="all in allSearchHistroyStore
                                            .searchHistoryList?.data"
                                        :key="all.id"
                                    >
                                        <ps-label
                                            textColor="text-feSecondary-800 dark:text-feSecondary-200 cursor-pointer"
                                            @click="historyClick(all.keyword)"
                                            >{{ all.keyword }}</ps-label
                                        >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            v-else
                        >
                            <ps-label textColor="text-feSecondary-500">{{
                                $t("core_fe__no_recent_searches")
                            }}</ps-label>
                        </div>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <div v-else>
                            <div
                                v-if="
                                    allSearchStore.allSearchList.data?.item ==
                                        '' &&
                                    allSearchStore.allSearchList.data
                                        ?.category == '' &&
                                    allSearchStore.allSearchList.data?.user ==
                                        ''
                                "
                            >
                                <div
                                ...
                                >
                                    <ps-label
                                        textColor="text-feSecondary-500"
                                        >{{
                                            $t("core_fe__no_suggestion")
                                        }}</ps-label
                                    >
                                </div>
                            </div>
                                ...
                                <div class="max-h-80 overflow-auto mt-6 pe-2">
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            v-for="item in allSearchStore.allSearchList.data.item.slice(
                                                0,
                                                3
                                            )"
                                            :key="item.id"
                                    ...
                                    >
                                        ...
                                        <div
                                            class="mt-3 flex flex-col gap-4"
                                            v-for="category in allSearchStore.allSearchList.data.category.slice(
                                                0,
                                                3
                                            )"
                                            :key="category.id"
                                    ...
                                    >
                                        ...
                                        <div
                                            class="mt-3 flex flex-col gap-4"
                                            v-for="user in allSearchStore.allSearchList.data.user.slice(
                                                0,
                                                3
                                            )"
                                            :key="user.id"
                    ...
                    <div class="" v-if="activeTabId == '1'">
                        <div
                            class=""
                            v-if="loginUserId != PsConst.NO_LOGIN_USER"
                        >
                            <div
                                v-if="loading"
                                class="w-full h-96 flex items-center justify-center"
                            ...
                            <div v-else>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            class="mt-3 flex flex-col gap-4"
                                            v-for="item in allSearchStore
                                                .allSearchList.data?.item"
                                            :key="item.id"
                                        >
                                            <ps-route-link
                                                :to="{
                                ...
                                <div v-else>
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                v-for="item in itemSearchHistroyStore
                                                    .searchHistoryList?.data"
                                                :key="item.id"
                                            >
                                                <ps-label
                        ...
                        <div v-else>
                            <div
                                v-if="allSearchStore.allSearchList.data != null"
                            >
                                <div
                                    v-if="loading"
                                    class="w-full h-96 flex items-center justify-center"
                            ...
                            <div v-else>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            class="mt-3 flex flex-col gap-4"
                                            v-for="category in allSearchStore
                                                .allSearchList.data?.category"
                                            :key="category.id"
                                        >
                                            <ps-route-link
                                                :to="{
                                ...
                                <div v-else>
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                v-for="category in categorySearchHistroyStore
                                                    .searchHistoryList?.data"
                                                :key="category.id"
                                            >
                                                <ps-label
                            ...
                            <div v-else>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            class="mt-3 flex flex-col gap-4"
                                            v-for="user in allSearchStore
                                                .allSearchList.data?.user"
                                            :key="user.id"
                                        >
                                            <ps-route-link
                                                :to="{
                                ...
                                <div v-else>
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                v-for="user in userSearchHistroyStore
                                                    .searchHistoryList?.data"
                                                :key="user.id"
                                            >
                                                <ps-label
...
export default defineComponent({
    ...
    setup() {
        ...
        const categorySearchHistroyStore =
            useSearchHistoryStoreState("category");
        ...
        const allSearchHistoryHolder =
            new SearchHistoryHolder().getAllSearchHistoryList();
        const itemSearchHistoryHolder =
            new SearchHistoryHolder().getItemSearchHistoryList();
        const categorySearchHistoryHolder =
            new SearchHistoryHolder().getCategorySearchHistoryList();
        const userSearchHistoryHolder =
            new SearchHistoryHolder().getUserSearchHistoryList();
        ...
        async function loadSearchHistoryList() {
            await allSearchHistroyStore.resetSearchHistoryList(
                loginUserId,
                allSearchHistoryHolder
            );
            await itemSearchHistroyStore.resetSearchHistoryList(
                loginUserId,
                itemSearchHistoryHolder
            );
            await categorySearchHistroyStore.resetSearchHistoryList(
                loginUserId,
                categorySearchHistoryHolder
            );
            await userSearchHistroyStore.resetSearchHistoryList(
                loginUserId,
                userSearchHistoryHolder
            );
        }
        ...
        async function searchClicked() {
            if (allSearchHolder.keyword == "") {
                ...
                loading.value = true;
                await allSearchStore.getSearchedDataList(
                    loginUserId,
                    allSearchHolder
                );
                loading.value = false;
        ...
        function showRecentSearch(type) {
            ...
            if (type == "all") {
                ...
                categorySearchHistroyStore.searchHistoryList.data.forEach(
                    (e) => {
                        historyIdsArr.value.push(e.id);
                    }
                );
        ...
        async function deleteHistory() {
            loading.value = true;
            await searchHistroyStore.deleteSearchHistroy(
                loginUserId,
