    ...
    <div class="shadow-sm relative bg-feSecondary-50 dark:bg-feSecondary-800 rounded-lg flex flex-col gap-4 p-4">
        ...
        <div class="grid grid-cols-2">
            <div class="flex items-center gap-1">
                ...
                <ps-label textColor="text-sm font-medium text-feSecondary-800 dark:text-feSecondary-50">{{block ? block.followerCount:'0'}} {{ $t("profile__followers")}}</ps-label>
            </div>
            <div class="flex items-center gap-1">
                <ps-icon class="text-feSecondary-800 dark:text-feSecondary-50" name="shoppingCart-fill" w="24" h="24" viewBox="0 0 24 24"/>
                <ps-label textColor="text-sm font-medium text-feSecondary-800 dark:text-feSecondary-50">{{block ? block.activeItemCount:'0'}} {{ $t("user__item") }}</ps-label>
            </div>
        </div>
