<template>
    <div class="flex flex-col mt-2 w-full h-auto cursor-pointer">
        <div
            class="relative bg-feAchromatic-900 lg:h-40 sm:h-28 h-20 rounded-md"
        >
            <div class="absolute opacity-50">
                <img
                    ...
                    width="150px"
                    height="100px"
                    class="w-screen block mx-auto lg:h-40 sm:h-28 h-20 object-cover rounded-md"
                    :src="
                        subCategoryStore.imageUrl(
                            subCategory ? subCategory.defaultPhoto.imgPath : '',
                            3
                        )
                    "
                    @error="subCategoryStore.defaultCarImage"
                />
            </div>
            ...
            <div class="relative justify-end flex">
                <custom-checkbox
                    ...
                    :checked="subCategory.id"
                    :value="subCategory.isSubScribe"
            ...
            <div class="mx-auto lg:pt-16 sm:pt-12 pt-10 relative">
                <ps-label
                    class="absolute w-full lg:text-lg sm:text-sm text-xs text-center leading-4"
