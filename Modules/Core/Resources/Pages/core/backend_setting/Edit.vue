    ...
    <ps-layout>
        <div class="">
            ...
            <ps-card class="w-full h-auto">
                <div
                    class="bg-background dark:bg-secondaryDark-black rounded-lg mb-20"
                >
                    <!-- card header start -->
                    <div
                    ...
                    <div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
                            <div>
                                ...
                                <div v-if="title == settingColumn[1].label">
                                    ...
                                    <div
                                        ...
                                        v-for="(
                                            coreField, index
                                        ) in coreFieldFilterSettings.filter(
                                            (coreField) =>
                                                coreField.original_field_name ===
                                                    'fcm_api_key' &&
                                                coreField.enable === 1 &&
                                                coreField.is_delete === 0
                                        )"
                                        :key="index"
                                    >
                                        <ps-label class="text-base"
                                            >{{ $t(coreField.label_name) }}
                                            <span
                                                v-if="(coreField.mandatory = 1)"
                                        ...
                                        <ps-textarea
                                            rows="4"
                                            ref="fcm_api_key"
                                            v-model:value="form.fcm_api_key"
                                            :placeholder="
                                ...
                                <div v-if="title == settingColumn[2].label">
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="sender_name"
                                            type="email"
                                            v-model:value="form.sender_name"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="sender_email"
                                            type="email"
                                            v-model:value="form.sender_email"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="receive_email"
                                            type="email"
                                            v-model:value="form.receive_email"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="smtp_encryption"
                                            type="text"
                                            v-model:value="form.smtp_encryption"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                ...
                                <div v-if="title == settingColumn[3].label">
                                    ...
                                    <div class="px-4 py-3">
                                        <ps-label class="text-base mb-1">{{
                                            $t("core__backend_fav_icon")
                                        }}</ps-label>
                                        <!-- <ps-input type="file" accept="image/*"   @input="form.fav_icon = $event.target.files"/> -->
                                        <ps-label
                                            v-if="!backend_setting.fav_icon[0]"
                                            textColor="text-secondary-400 text-xs"
                                        >
                                            {{
                                                $t(
                                                    "core__be_recommended_size_16_16"
                                                )
                                            }}
                                        </ps-label>
                                        <div
                                    ...
                                    <div class="px-4 py-3">
                                        <ps-label class="text-base mb-1">{{
                                            $t("core__backend_water_mask_image")
                                        }}</ps-label>
                                        <ps-label
                                            v-if="
                                                !backend_setting
                                                    .backend_water_mask_image[0]
                                            "
                                            textColor="text-secondary-400 text-xs"
                                        >
                                            {{
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.backend_water_mask_image
                                            }}</ps-label-caption
                                        >
                                    </div>
                                ...
                                <div v-if="title == settingColumn[4].label">
                                    <ps-label class="text-lg px-4 py-3">{{
                                        $t("core__org_image_size")
                                    }}</ps-label>
                                    <div
                                        class="px-4 py-3"
                                        v-for="(
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="landscape_width"
                                            type="text"
                                            v-model:value="form.landscape_width"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="potrait_height"
                                            type="text"
                                            v-model:value="form.potrait_height"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="square_height"
                                            type="text"
                                            v-model:value="form.square_height"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.square_height
                                            }}</ps-label-caption
                                        >
                                    </div>

                                    <ps-label class="text-lg px-4 py-3">{{
                                        $t("core__thumb1x_img_size")
                                    }}</ps-label>
                                    <div
                                        class="px-4 py-3"
                                        v-for="(
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="landscape_thumb_width"
                                            type="text"
                                            v-model:value="
                                                form.landscape_thumb_width
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="potrait_thumb_height"
                                            type="text"
                                            v-model:value="
                                                form.potrait_thumb_height
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="square_thumb_height"
                                            type="text"
                                            v-model:value="
                                                form.square_thumb_height
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.square_thumb_height
                                            }}</ps-label-caption
                                        >
                                    </div>

                                    <ps-label class="text-lg px-4 py-3">{{
                                        $t("core__thumb2x_img_size")
                                    }}</ps-label>
                                    <div
                                        class="px-4 py-3"
                                        v-for="(
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="landscape_thumb2x_width"
                                            type="text"
                                            v-model:value="
                                                form.landscape_thumb2x_width
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.landscape_thumb2x_width
                                            }}</ps-label-caption
                                        >
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="potrait_thumb2x_height"
                                            type="text"
                                            v-model:value="
                                                form.potrait_thumb2x_height
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="square_thumb2x_height"
                                            type="text"
                                            v-model:value="
                                                form.square_thumb2x_height
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.square_thumb2x_height
                                            }}</ps-label-caption
                                        >
                                    </div>

                                    <ps-label class="text-lg px-4 py-3">{{
                                        $t("core__thumb3x_img_size")
                                    }}</ps-label>
                                    <div
                                        class="px-4 py-3"
                                        v-for="(
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="landscape_thumb3x_width"
                                            type="text"
                                            v-model:value="
                                                form.landscape_thumb3x_width
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.landscape_thumb3x_width
                                            }}</ps-label-caption
                                        >
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="potrait_thumb3x_height"
                                            type="text"
                                            v-model:value="
                                                form.potrait_thumb3x_height
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="square_thumb3x_height"
                                            type="text"
                                            v-model:value="
                                                form.square_thumb3x_height
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                ...
                                <div v-if="title == settingColumn[5].label">
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="dyn_link_key"
                                            type="text"
                                            v-model:value="form.dyn_link_key"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="dyn_link_domain"
                                            type="text"
                                            v-model:value="form.dyn_link_domain"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="dyn_link_url"
                                            type="text"
                                            v-model:value="form.dyn_link_url"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="dyn_link_deep_url"
                                            type="text"
                                            v-model:value="
                                                form.dyn_link_deep_url
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="dyn_link_package_name"
                                            type="text"
                                            v-model:value="
                                                form.dyn_link_package_name
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="ios_boundle_id"
                                            type="text"
                                            v-model:value="form.ios_boundle_id"
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                            @keyup="
                                ...
                                <div v-if="title == settingColumn[6].label">
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="slow_moving_item_limit"
                                            type="text"
                                            v-model:value="
                                                form.slow_moving_item_limit
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                        ...
                                        <ps-label-caption
                                            ...
                                            class="mt-2 block"
                                            >{{
                                                errors.slow_moving_item_limit
                                            }}</ps-label-caption
                                        >

                                        <ps-label
                                            class="ms-2 mt-1 text-sm"
                                            textColor="text-secondary-400"
                                            >{{
                                                $t(
                                                    "slow_moving_item_limit_info"
                                                )
                                            }}<span
                                                class="text-red-800 font-medium ms-1"
                                                >*</span
                                ...
                                <div v-if="title == settingColumn[7].label">
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="search_item_limit"
                                            type="text"
                                            v-model:value="
                                                form.search_item_limit
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="search_category_limit"
                                            type="text"
                                            v-model:value="
                                                form.search_category_limit
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    >
                                        ...
                                        >
                                        <ps-input
                                            ref="search_user_limit"
                                            type="text"
                                            v-model:value="
                                                form.search_user_limit
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                ...
                                <div v-if="title == settingColumn[8].label">
                                    ...
                                    >
                                        <div class="flex justify-between">
                                            ...
                                            <ps-toggle
                                                ...
                                                toggleOnTheme="bg-primary-500 border-primary-500 "
                                            ></ps-toggle>
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="form.is_watermask == 1">
                                        ...
                                        >
                                            ...
                                            >
                                            <ps-input
                                                ref="watermask_image_size"
                                                type="number"
                                                v-model:value="
                                                    form.watermask_image_size
                                                "
                                                :placeholder="
                                                    $t(coreField.placeholder)
                                                "
                                        ...
                                        <div class="px-4 py-3">
                                            <ps-label class="text-base mb-1">{{
                                                $t("water_mask_background")
                                            }}</ps-label>
                                            <ps-label
                                                v-if="
                                                    !backend_setting
                                                        .water_mask_background[0]
                                                "
                                                textColor="text-secondary-400 text-xs"
                                            >
                                                {{
                                            ...
                                            <ps-label-caption
                                                ...
                                                class="mt-2 block"
                                                >{{
                                                    errors.water_mask_background
                                                }}</ps-label-caption
                                            >
                                        </div>

                                        <ps-label class="py-3 text-xl">{{
                                            $t("water_mask_preview")
                                        }}</ps-label>
                                        <div
                                            class="container mx-auto grid-cols-4 lg:space-y-0 lg:gap-2 lg:grid lg:grid-cols-4"
                                            v-if="reRenderImage"
                                        >
                                            <div
                                                v-if="
                                            ...
                                            >
                                                ...
                                                <ps-label
                                                    class="text-base grid place-items-center"
                                                    >{{ $t("org_img_preview") }}
                                                </ps-label>
                                            </div>
                                ...
                                <div v-if="title == settingColumn[11].label">
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <ps-checkbox-value
                                                v-model:value="
                                                    form.user_social_info_override
                                                "
                                                class="font-normal"
                                                :title="
                                                    $t(coreField.placeholder)
                                    ...
                                    >
                                        ...
                                        <ps-dropdown class="w-full" h="h-auto">
                                            ...
                                            <template #list>
                                                <div class="">
                                                    <div
                                                        v-for="row in uploadSettingList"
                                                        :key="row.id"
                                                        class="w-56"
                                                    >
                                                        <ps-label
                                    ...
                                    >
                                        <div class="flex items-center">
                                            ...
                                            />
                                            <ps-tooltip
                                                tooltiptext="absolute  bottom-full"
                                            >
                                                <template #content>
                                                    <ps-icon
                                                        name="info"
                                    ...
                                    >
                                        ...
                                        <ps-input
                                            ref="backend_version_no"
                                            type="text"
                                            v-model:value="
                                                form.backend_version_no
                                            "
                                            :placeholder="
                                                $t(coreField.placeholder)
                                            "
                                    ...
                                    <ps-card class="w-full h-auto">
                                        <div class="rounded-xl">
                                            ...
                                            <div class="mt-6">
                                                <div class="">
                                                    <div
                                                        class="border border-1 rounded p-4"
                                                    >
                                                        <div class="h-auto">
                                                            <!-- <div class="mb-2">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <ps-icon
                                                                        name="refresh"
                                                                        class="me-2 font-semibold"
                                                                    />
                                                                    <ps-label
                                                                        textColor="text-white dark:text-secondary-800"
                                                                        >{{
                                                                            $t(
                                                                                "core__be_lang_refresh"
                                                                            )
                                                                        }}</ps-label
                                                                    >
                                                                </ps-button>
                                ...
                                >
                                    ...
                                    >
                                    <ps-button
                                        :disabled="!can.updateBackendSetting"
                                        @click="
                                            handleSubmit(
                                                this.backend_setting.id
                                            )
                                        "
                                        class="transition-all duration-300 min-w-3xs me-4"
                                        padding="px-8 py-0"
                                        rounded="rounded"
                                        hover=""
                                        focus=""
                                ...
                                >
                                    <div
                                        class="p-4 border border-secondary-100 rounded-lg"
                                    >
                                        <ps-label class="text-lg mb-2">{{
                                            $t("core__be_smtp_check")
                                        }}</ps-label>
                                        <ps-label class="text-base mb-2">{{
                                            $t("core__be_smtp_check_info")
                                        }}</ps-label>
                                        ...
                                        <div class="">
                                            <ps-label class="text-base mb-1"
                                                >{{
                                                    $t(
                                                        "core__be_smtp_check_email_label"
                                                    )
                                                }}
                                            </ps-label>
                                            <ps-input
                                                ...
                                                :placeholder="
                                                    $t(
                                                        'core__be_smtp_check_email_placeholder'
                                                    )
                                                "
                                            />
                                            <ps-label-caption
                                        ...
                                        <div
                                            class="flex flex-row pt-2 justify-end"
                                        >
                                            <ps-button
                                                @click="handleCancel()"
                                                textSize="text-base"
                            ...
                            <div class="px-4">
                                <div
                                    v-for="column in settingColumn.slice(1)"
                                    :key="column.id"
                                >
                                    <div
...
export default defineComponent({
    ...
    setup(props) {
        ...
        let form = useForm({
            ...
            email_verification_enabled:
                props.backend_setting.email_verification_enabled == 1
                    ? true
                    : false,
            user_social_info_override:
                props.backend_setting.user_social_info_override == 1
                    ? true
                    : false,
            ...
            landscape_thumb2x_width:
                props.backend_setting.landscape_thumb2x_width,
            potrait_thumb2x_height:
                props.backend_setting.potrait_thumb2x_height,
            square_thumb2x_height: props.backend_setting.square_thumb2x_height,
            landscape_thumb3x_width:
                props.backend_setting.landscape_thumb3x_width,
            potrait_thumb3x_height:
                props.backend_setting.potrait_thumb3x_height,
            ...
            slow_moving_item_limit:
                props.backend_setting.slow_moving_item_limit,
        ...
        const validateEmailInput = (
            ...
            props.errors[fieldName] = !fieldValue
                ...
                : isEmail(fieldName, fieldValue, errorMessage2);
        };
        ...
        function openSuccessDialog() {
            ps_success_dialog.value.openModal(
                trans("core__be_smtp_configuration_check"),
                trans("smtp_configuration_is_success"),
                trans("btn_back"),
                () => {
        ...
        function openErrorDialog() {
            ps_error_dialog.value.openModal(
                trans("core__be_smtp_configuration_check"),
                trans("smtp_configuration_is_fail"),
        ...
        function checkSmtpConfiguration() {
            ...
            //     () => {
            this.$inertia.get(
                route("backend_setting.checkSmtpConfig"),
                smtpCheckForm,
                {
                    onSuccess: () => {
                        visible.value = true;
        ...
        function colorPickerClicked(data) {
            ...
            ps_color_picker_modal.value.openModal(
                ...
                (selectedColor) => {
                    ...
                    this.$inertia.post(
                        route("color.update", data.id),
                        colorForm,
                        {
                            forceFormData: true,
                            onFinish: () => {
                                this.$inertia.get(
                                    route("backend_setting.index")
                                );
                            },
                        }
                    );
        ...
        function langRefreshSuccessDialog() {
            ps_success_dialog.value.openModal(
                trans("core__be_awesome_title"),
                trans("core__be_lang_refresh_success_desc"),
                trans("core__be_btn_back"),
                () => {},
                true
            );
        }
        ...
        function handleLangRefresh() {
            this.$inertia.get(
                route("backend_setting.languageRefresh"),
                { key: "refresh" },
                {
                    onBefore: () => {
                        ps_loading_circle_dialog.value.openModal(
                            trans("core__be_updating_title"),
                            trans("core__be_lang_refreshing_desc")
                        );
                    },
                    onSuccess: () => {
                        // ps_loading_circle_dialog.value.closeModal();
