        ...
        >
            ...
            <template #searchLeft>
                <ps-button
                    ...
                    rounded="rounded"
                    class="flex flex-wrap items-center ms-3"
                >
                    <ps-icon name="plus" class="me-2 font-semibold" />
                    <ps-label textColor="text-white dark:text-secondary-800">{{
            ...
            <template #tableActionRow="rowProps">
                ...
                <div class="flex flex-row" v-if="rowProps.field == 'action'">
                    <ps-button
                        :disabled="
                            rowProps.row.authorization.update ? false : true
                        "
                    ...
                    <ps-button
                        :disabled="
                            rowProps.row.authorization.delete ? false : true
                        "
                ...
                <div v-if="rowProps.field == 'status' && reRenderToogle">
                    <ps-toggle
                        ...
                        @click="
                            handlePublish(
                                rowProps.row.id,
                                rowProps.row.authorization.update
                            )
                        "
                    ></ps-toggle>
                </div>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function csvUploadClicked() {
            ps_csv_modal.value.openModal((selectedFile) => {
                let form = useForm({
    ...
    methods: {
        ...
        FilterOptionshandle(value) {
            router.put(
                route("category.screenDisplayUiSetting.store"),
                {
                    value,
