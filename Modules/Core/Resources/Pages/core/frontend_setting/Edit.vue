                        ...
                        <div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ps-input
                                        ref="app_store_url"
                                        v-model:value="form.app_store_url"
                                        :placeholder="$t(coreField.placeholder)"
                                        @keyup="
                                            coreField.mandatory == 1
                                                ? validateEmptyInput(
                                ...
                                >
                                    <ps-checkbox-value
                                        v-model:value="form.google_setting"
                                        class="font-normal"
                                ...
                                >
                                    <ps-checkbox-value
                                        v-model:value="form.app_store_setting"
                                        class="font-normal"
                                        :title="$t(coreField.placeholder)"
                                    />
                                </div>
                            ...
                            >
                                <div class="px-4 py-3">
                                    <ps-label class="text-base mb-1"
                                        >{{ $t("core__frontend_logo") }}
                                    </ps-label>

                                    <ps-label
                                        v-if="
                                            !frontend_setting.frontend_logo[0]
                                        "
                                    ...
                                    <div
                                        v-if="frontend_setting.frontend_logo[0]"
                                    ...
                                    <ps-image-upload
                                        ...
                                        class="w-72"
                                        uploadType="icon"
                                        v-model:imageFile="form.frontend_logo"
                                    />
                                    <ps-label-caption
                                        textColor="text-red-500 "
                                        class="mt-2 block"
                                        >{{
                                            errors.frontend_logo
                                        }}</ps-label-caption
                                    >
                                </div>
                                ...
                                <div class="px-4 py-3">
                                    <ps-label class="text-base mb-1"
                                        >{{ $t("core__frontend_icon") }}
                                    </ps-label>

                                    <ps-label
                                        v-if="
                                            !frontend_setting.frontend_icon[0]
                                        "
                                        textColor="text-secondary-400 text-xs"
                                    >
                                        {{
                                    ...
                                    <div
                                        v-if="frontend_setting.frontend_icon[0]"
                                        class="flex items-end pt-4"
                                    >
                                        <img
                                            v-lazy="{
                                    ...
                                    <ps-image-upload
                                        ...
                                        class="w-72"
                                        uploadType="icon"
                                        v-model:imageFile="form.frontend_icon"
                                    />
                                    <ps-label-caption
                                        textColor="text-red-500 "
                                        class="mt-2 block"
                                        >{{
                                            errors.frontend_icon
                                        }}</ps-label-caption
                                    >
                                </div>
                                <div class="px-4 py-3">
                                    <ps-label class="text-base mb-1"
                                        >{{ $t("core__frontend_banner") }}
                                    </ps-label>

                                    <ps-label
                                        v-if="
                                            !frontend_setting.frontend_banner[0]
                                        "
                                        textColor="text-secondary-400 text-xs"
                                    >
                                        {{
                                            $t(
                                                "core__be_recommended_size_2048_1000"
                                            )
                                        }}
                                    </ps-label>
                                    <div
                                    ...
                                    <ps-image-upload
                                        ...
                                        class="w-72"
                                        uploadType="icon"
                                        v-model:imageFile="form.frontend_banner"
                                    />
                                    <ps-label-caption
                                        textColor="text-red-500 "
                                        class="mt-2 block"
                                        >{{
                                            errors.frontend_banner
                                        }}</ps-label-caption
                                    >
                                </div>
                                ...
                                <div class="px-4 py-3">
                                    <ps-label class="text-base mb-1"
                                        >{{ $t("core__be_app_branding_image") }}
                                    </ps-label>

                                    <ps-label
                                        v-if="
                                            !frontend_setting
                                                .app_branding_image[0]
                                        "
                                        textColor="text-secondary-400 text-xs"
                                    >
                                        {{
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ps-textarea
                                        rows="4"
                                        ref="firebase_web_push_key_pair"
                                        v-model:value="
                                            form.firebase_web_push_key_pair
                                        "
                                        :placeholder="$t(coreField.placeholder)"
                                        @keyup="
                                            coreField.mandatory == 1
                                    ...
                                    <ps-label-caption
                                        ...
                                        class="mt-2 block"
                                        >{{
                                            errors.firebase_web_push_key_pair
                                        }}</ps-label-caption
                                    >
                                </div>
                                ...
                                >
                                    ...
                                    <ps-textarea
                                        rows="4"
                                        ref="firebase_config"
                                        v-model:value="form.firebase_config"
                                        :placeholder="$t(coreField.placeholder)"
                                        @keyup="
                                            coreField.mandatory == 1
                                                ? validateEmptyInput(
                            ...
                            <div
                                class="grid grid-rows gap-6 ms-4"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ps-input
                                        ref="frontend_meta_title"
                                        v-model:value="form.frontend_meta_title"
                                        :placeholder="$t(coreField.placeholder)"
                                        @keyup="
                                            coreField.mandatory == 1
                                                ? validateEmptyInput(
                                                      'frontend_meta_title',
                                                      form.frontend_meta_title
                                                  )
                                                : ''
                                        "
                                        @blur="
                                ...
                                >
                                    ...
                                    <ps-textarea
                                        rows="4"
                                        ref="frontend_meta_description"
                                        v-model:value="
                                            form.frontend_meta_description
                                        "
                                        :placeholder="$t(coreField.placeholder)"
                                        @keyup="
                                            coreField.mandatory == 1
                                    ...
                                    <ps-label-caption
                                        ...
                                        class="mt-2 block"
                                        >{{
                                            errors.frontend_meta_description
                                        }}</ps-label-caption
                                    >
                                </div>
                                ...
                                <div class="px-4 py-3">
                                    <ps-label class="text-base mb-1"
                                        >{{ $t("core__backend_meta_image") }}
                                    </ps-label>

                                    <ps-label
                                        v-if="
                                            !frontend_setting
                                                .frontend_meta_image[0]
                                        "
                                        textColor="text-secondary-400 text-xs"
                                    >
                                        {{
                            ...
                            >
                                <div>
                                    ...
                                    <div
                                        class="pt-6 border-t mt-8 border-secondary-800 dark:border-secondary-100"
                                    >
                                        <div
                                            class="border border-1 rounded p-4"
                                        >
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const checkedSelectedList = ref(
            props.frontend_setting.selected_language
                ? props.frontend_setting.selected_language
                : []
        );
        ...
        const form = reactive(
            useForm({
                ...
                is_enable_video_setting:
                    props.frontend_setting.is_enable_video_setting == 1
                        ? true
                        : false,
                show_user_profile:
                    props.frontend_setting.show_user_profile == 1
                        ? true
                        : false,
                no_filter_with_location_on_map:
                    props.frontend_setting.no_filter_with_location_on_map == 1
                        ? true
                        : false,
                price_format: props.frontend_setting.price_format,
                enable_notification:
                    props.frontend_setting.enable_notification == 1
                        ? true
                        : false,
                fcm_server_key: props.frontend_setting.fcm_server_key,
                firebase_web_push_key_pair:
                    props.frontend_setting.firebase_web_push_key_pair,
                ...
                google_playstore_url:
                    props.frontend_setting.google_playstore_url,
                google_setting:
                    props.frontend_setting.google_setting == 1 ? true : false,
                app_store_url: props.frontend_setting.app_store_url,
                app_store_setting:
                    props.frontend_setting.app_store_setting == 1
                        ? true
                        : false,
                banner_src: props.frontend_setting.banner_src,
                google_map:
                    props.frontend_setting.google_map == 1 ? true : false,
                open_street_map:
                    props.frontend_setting.open_street_map == 1 ? true : false,
                mile: props.frontend_setting.mile,
                default_language: props.frontend_setting.default_language,
                promote_first_choice_day:
                    props.frontend_setting.promote_first_choice_day,
                // selected_language: checkedSelectedList,
                selected_language: [],
                promote_second_choice_day:
                    props.frontend_setting.promote_second_choice_day,
                promote_third_choice_day:
                    props.frontend_setting.promote_third_choice_day,
                promote_fourth_choice_day:
                    props.frontend_setting.promote_fourth_choice_day,
                gps_enable:
                    props.frontend_setting.gps_enable == 1 ? true : false,
                show_main_menu:
                    props.frontend_setting.show_main_menu == 1 ? true : false,
                show_special_collections:
                    props.frontend_setting.show_special_collections == 1
                        ? true
                        : false,
                show_featured_items:
                    props.frontend_setting.show_featured_items == 1
                        ? true
                        : false,
                show_best_choice_slider:
                    props.frontend_setting.show_best_choice_slider == 1
                        ? true
                        : false,
                ...
                frontend_meta_description:
                    props.frontend_setting.frontend_meta_description,
                frontend_meta_image: "",
                app_branding_image: "",
                //  "_method": "put"
            })
        ...
        function getGeneratedColor(color) {
            color.forEach((col) => {
                frontendColors.value.filter((fe) => fe.id == col.id)[0].value =
                    col.value;
            });
        ...
        const primaryColors = ref(
            props.frontendColors.filter((fe) => fe.title == "fePrimary")
        );
        const textColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feSecondary")
        );
        const accentColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feAccent")
        );
        const successColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feSuccess")
        );
        const errorColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feError")
        );
        const warningColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feWarning")
        );
        const infoColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feInfo")
        );
        const achromaticColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feAchromatic")
        );
        const brandColors = ref(
            props.frontendColors.filter((fe) => fe.title == "feBrand")
        );
        ...
        function handleSubmit(id) {
            if (isFirebaseJson(form.firebase_config)) {
                isJson.value = true;
                form.firebase_config = JSON.stringify(
                    JSON.parse(form.firebase_config)
                );
            } else {
                isJson.value = false;
                return;
        ...
        function handleColorGenerate() {
            ...
            this.$inertia.post(
                route("frontend_setting.colorGenerate"),
                colorform,
                {
                    onBefore: () => {
                        ps_loading_circle_dialog.value.openModal(
                            trans("core__be_generating_title"),
                            trans("core__be_color_generating_desc")
                        );
                    },
                    onSuccess: () => {
        ...
        function handleFeLangRefresh() {
            this.$inertia.get(
                route("frontend_setting.languageRefresh"),
                { key: "refresh" },
                {
                    onBefore: () => {
                        ps_loading_circle_dialog.value.openModal(
        ...
        function colorGenerateSuccessDialog() {
            ps_success_dialog.value.openModal(
                trans("core__be_awesome_title"),
                trans("core__be_color_generate_success_desc"),
                trans("core__be_reload"),
                () => {
    ...
    created() {
        ...
        for (let language in this.available_languages) {
            for (let k in selected_language) {
                if (
                    selected_language[k] ==
                    this.available_languages[language].language_code
                ) {
                    this.form.selected_language[i] =
                        this.available_languages[language];
                    i = i + 1;
                    continue;
                }
            }
