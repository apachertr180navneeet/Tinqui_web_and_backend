            ...
            <div class="rounded-xl">
                ...
                >
                    <ps-label-header-6
                        ...
                        >{{ $t("core__be_user_info") }}</ps-label-header-6
                    >
                </div>
                <!-- card header end -->
                        ...
                        <div class="grid w-full sm:w-1/2 gap-6">
                            ...
                            >
                                ...
                                <ps-label-caption
                                    ...
                                    textColor="text-red-500 "
                                    class="mt-2 block"
                                    >{{ errors.username }}</ps-label-caption
                                >
                            </div>
                            ...
                            >
                                ...
                                <ps-label-caption
                                    ...
                                    textColor="text-red-500 "
                                    class="mt-2 block"
                                    >{{ errors.role_id }}</ps-label-caption
                                >
                            </div>
                            <!-- end role -->
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ps-label
                                        ...
                                        class="mb-0.5 text-sm cursor-pointer"
                                        textColor="text-primary-500"
                                    >
                                        <span v-if="emailVerified"
                                            >Verified </span
                                        ><span v-else>Verify </span></ps-label
                                    >
                                </div>
                                <ps-input
                                    ref="email"
                            ...
                            >
                                ...
                                <ps-label-caption
                                    ...
                                    textColor="text-red-500 "
                                    class="mt-2 block"
                                    >{{ errors.user_phone }}</ps-label-caption
                                >
                            </div>

                            <div
                                v-if="
                                    user.verify_types.includes(2) ||
                                    user.verify_types.includes(5) ||
                                    user.verify_types.includes(3)
                                "
                                class="flex flex-col space-y-5"
                            >
                                <div class="flex flex-row">
                                    <div
                                        v-if="user.verify_types.includes(2)"
                                        class="p-1 rounded-md border border-secondary-200 flex flex-row items-center flex-grow-0"
                                    >
                                        <ps-icon
                                            name="bluemark"
                                            w="20"
                                        ...
                                        />
                                        <ps-label class="mx-2">{{
                                            $t("core__be_verified_with_google")
                                        }}</ps-label>
                                        <img
                                            :src="
                                ...
                                <div class="flex flex-row">
                                    <div
                                        v-if="user.verify_types.includes(5)"
                                        class="p-1 rounded-md border border-secondary-200 flex flex-row items-center flex-grow-0"
                                    >
                                        <ps-icon
                                            name="bluemark"
                                        ...
                                        />
                                        <ps-label class="mx-2">{{
                                            $t("core__be_verified_with_apple")
                                        }}</ps-label>
                                        <img
                                            :src="
                                                $page.props.sysImageUrl +
                                ...
                                <div class="flex flex-row">
                                    <div
                                        v-if="user.verify_types.includes(3)"
                                        class="p-1 rounded-md border border-secondary-200 flex flex-row items-center flex-grow-0"
                                    >
                                        <ps-icon
                                            name="bluemark"
                                        ...
                                        <ps-label class="mx-2">{{
                                            $t(
                                                "core__be_verified_with_facebook"
                                            )
                                        }}</ps-label>
                                        <img
                                            :src="
                            ...
                            <div>
                                <ps-label class="text-base"
                                    >{{ $t("core__be_user_conf_password") }}
                                    <span class="text-red-800 font-medium ms-1"
                                        >*</span
                                    ></ps-label
                                >
                                <ps-input
                                    ref="conf_password"
                                    type="password"
                                    v-model:value="form.conf_password"
                                    :placeholder="
                                        $t('core__be_user_conf_password')
                                    "
                                />
                            ...
                            >
                                ...
                                <ps-textarea
                                    rows="4"
                                    v-model:value="form.user_about_me"
                                    :placeholder="$t(coreField.placeholder)"
                                    @keyup="
                                        coreField.mandatory == 1
                                            ? validateEmptyInput(
                            ...
                            >
                                ...
                                <ps-textarea
                                    rows="4"
                                    v-model:value="form.user_address"
                                    :placeholder="$t(coreField.user_address)"
                                />
                                <ps-label-caption
                                    v-if="coreField.mandatory == 1"
                                    textColor="text-red-500 "
                                    class="mt-2 block"
                                    >{{ errors.user_address }}</ps-label-caption
                                >
                            </div>
                            ...
                            <div>
                                ...
                                >
                                <ps-label-title-3
                                    v-if="!user.user_cover_photo"
                                    >{{
                                        $t("core__be_recommended_size_200_200")
                                    }}</ps-label-title-3
                                >
                                <div
                                    v-if="user.user_cover_photo"
                                ...
                                >
                                    <img
                                        ...
                                        class="w-48 h-48"
                                        :alt="$t(core__be_user_cover_photo)"
                                    />
                                    <ps-button
                                        type="button"
                                        @click="replaceImageClicked(user.id)"
                                ...
                                <ps-image-upload
                                    ...
                                    uploadType="image"
                                    class="w-48"
                                    v-model:imageFile="form.user_cover_photo"
                                />
                                <ps-label-caption
                                    textColor="text-red-500 "
                                    class="mt-2 block"
                                    >{{
                                        errors.user_cover_photo
                                    }}</ps-label-caption
                                >
                            </div>

                            <ps-label class="text-base">{{
                                $t("core__be_show_phone_email")
                            }}</ps-label>
                            <!-- is_show_phone-->
                            <div
                                v-for="(
                            ...
                            >
                                <ps-checkbox-value
                                    v-model:value="form.is_show_phone"
                                    class="font-normal"
                            ...
                            >
                                <ps-checkbox-value
                                    v-model:value="form.is_show_email"
                                    class="font-normal"
                                    :title="$t(coreField.placeholder)"
                                />
                            </div>
                            <!-- custom field start -->
                            <div
                                v-for="custom_field_header in customizeHeaders"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        let form = useForm({
            ...
            role_id: props.roles.find(
                (element) => element.id == props.user.role_id
            )
                ? props.user.role_id
                : "",
        ...
        function handleSubmit(id) {
            ...
            // console.log(route("user.update", id));
        ...
        function handleCustomFieldError(custom_field_header) {
            custom_field_header.mandatory === 1
                ? validateEmptyInput(
                      custom_field_header.name,
                      form.user_relation[custom_field_header.core_keys_id]
                  )
                : "";
        }
        ...
        this.customizeHeaders.map((customizeHeader, index) => {
            this.user.user_relation.map((value) => {
                if (customizeHeader.core_keys_id === value.core_keys_id) {
                    ...
                    this.form.user_relation[customizeHeader.core_keys_id] =
                        data === "1" ? true : data === "0" ? false : data;
                }
            });
        });
    },
