<template>
    ...
    <ps-layout>
        ...
        <div class="w-full md:w-196 xl:196">
            <div
                class="mt-8 rounded-lg bg-secondary-50 dark:bg-secondary-900 border border-secondary-200 dark:bprder-secondary-900 shadow-md ps-6 pe-6 md:ps-8 md:pe-24 py-6"
                v-if="selectedClientTable.core_key_type_id == 1"
            >
                <ps-label-header-5
                ...
                <div class="mt-4 md:mt-6 grid grid-cols-3 items-center">
                    <ps-label class="text-base">{{
                        $t("core__category_label")
                    }}</ps-label>
                    <ps-dropdown
                        align="left"
                        class="col-span-2 w-full border-red-500"
                    >
                        <template #select>
                            <ps-dropdown-select
                                :placeholder="$t('core_be_select_category')"
                                :selectedValue="
                                    form.category_id == ''
                                        ? $t(
                                              'core__be_general_for_all_category'
                                          )
                                        : categories.filter(
                                              (category) =>
                                                  category.id ===
            ...
            <ps-label
                v-if="selectedClientTable.core_key_type_id == 1"
                class="px-6 mt-4 text-sm md:text-base"
            >
                <span class="text-red-500">*</span
                >{{ $t("core__be_choose_category_for_custom_field_desc") }}
                <span class="text-red-500">*</span></ps-label
            >
            ...
            <div class="mt-10">
                ...
                <div>
                    <div
                        class="bg-white dark:bg-secondary-900 rounded-lg border border-secondary-200 dark:bprder-secondary-900 shadow-lg"
                    >
                        <ps-label-header-5
                            textColor="py-4 ps-6 pe-6 md:ps-8 md:pe-24 text-secondary-800 dark:text-secondary-100"
                        >
                        ...
                        <hr class="" />
                        <div
                            class="py-6 ps-6 pe-6 md:ps-8 md:pe-24 flex flex-col space-y-6"
                        >
                            <div class="grid grid-cols-3 items-center">
                                <ps-label class="text-base">
                                    {{ $t("core_custom__name_label")
                                    }}<span
                                        class="text-red-500 font-medium ms-1"
                                        >*</span
                                    >
                                </ps-label>
                                ...
                                <div class="w-full col-span-2">
                                    <ps-input-with-right-icon
                                        ...
                                        :disabled="true"
                                        v-model:value="nameString"
                                        :placeholder="
                                            $t(
                                                'core_custom__name_placeholder'
                                            ) +
                                            ' (' +
                                            activeLanguageName +
                                            ')'
                                ...
                                <ps-label-caption
                                    ...
                                    v-if="validiteName"
                                    class="col-span-3 mt-2 block"
                                    >{{
                                        $t("core__be_name_required")
                                    }}</ps-label-caption
                                >
                            </div>
                            ...
                            <div class="grid grid-cols-3 items-center">
                                <ps-label class="text-base">
                                    {{ $t("core_custom__placeholder_label")
                                    }}<span
                                        class="text-red-500 font-medium ms-1"
                                        >*</span
                                    >
                                ...
                                <div class="w-full col-span-2">
                                    <ps-input-with-right-icon
                                        class="w-full text-base"
                                        :disabled="true"
                                        v-model:value="placeholderString"
                                        :placeholder="
                                            $t(
                                                'core_custom__placeholder_placeholder'
                                            ) +
                                            ' (' +
                                            activeLanguageName +
                                            ')'
                                ...
                                <ps-label-caption
                                    textColor="text-red-500 "
                                    v-if="validitePlaceholder"
                                    class="col-span-3 mt-2 block"
                                    >{{
                                        $t("core__be_placeholder_required")
                                    }}</ps-label-caption
                                >
                            </div>
                            ...
                            <div class="grid grid-cols-3 items-center">
                                ...
                                >
                                    <template #select>
                                        <ps-dropdown-select
                                            :placeholder="
                                                $t(
                                                    'core_custom__select_ui_type_label'
                                                )
                                            "
                                            :selectedValue="
                                                form.ui_type_id == ''
                                        ...
                                        <div class="rounded-md shadow-xs w-56">
                                            <div class="pt-2 z-30">
                                                ...
                                                <div
                                                    ...
                                                    :key="uiType.core_keys_id"
                                                    class="w-56 flex py-4 px-2 hover:bg-primary-000 dark:hover:bg-primary-900 cursor-pointer items-center"
                                                    @click="
                                                        [
                                                            (validiteUIType = false),
                                                            (form.ui_type_id =
                                                                uiType.core_keys_id),
                                                            validateEmptyInput(
                                                                'ui_type_id',
                                ...
                                <ps-label-caption
                                    ...
                                    class="col-span-3 mt-2 block"
                                    >{{
                                        $t("core__be_ui_type_is_required")
                                    }}</ps-label-caption
                                >
                            </div>
                            ...
                            <div class="grid grid-cols-3 items-center">
                                <ps-label class="text-base"
                                    >{{
                                        $t(
                                            "core__custom_type_of_conditions_label"
                                        )
                                    }}<span
                                        class="text-red-500 font-medium ms-1"
                                        >*</span
                                ...
                                <ps-radio-value
                                    ...
                                    title="1"
                                    :title_label="
                                        $t('core__custom_mandatory_label')
                                    "
                                />
                                <ps-radio-value
                                    v-model:value="form.mandatory"
                            ...
                            <div class="grid grid-cols-3 items-center">
                                <ps-label class="text-base">
                                    {{ $t("core__custom_column_order_label")
                                    }}<span
                                        class="text-red-500 font-medium ms-1"
                                        >*</span
                                    >
                                ...
                                <ps-input
                                    class="col-span-2"
                                    type="number"
                                    v-model:value.number="form.ordering"
                                    :placeholder="
                                        $t('column_order_placeholder')
                                    "
                                    @keypress="validateNumber($event)"
                                />
                                <ps-label-caption
                                    textColor="text-red-500 "
                                    v-if="validiteOrdering"
                                    class="col-span-3 mt-2 block"
                                    >{{
                                        $t("core__be_ordering_required")
                                    }}</ps-label-caption
                                >
                            </div>
                        </div>
                    ...
                    <div
                        class="mt-6 md:mt-8 bg-white dark:bg-secondary-900 rounded-lg border border-secondary-200 dark:bprder-secondary-900 shadow-lg"
                    >
                        <ps-label-header-5
                            textColor="py-4 ps-6 pe-6 md:ps-8 md:pe-24 text-secondary-800 dark:text-secondary-100"
                        >
                        ...
                        >
                            <div class="flex justify-between">
                                <ps-label class="text-base">
                                    {{
                                        $t(
                                            "core__custom_enable_sorting_this_field"
                                        )
                                    }}</ps-label
                                >
                                <ps-toggle
                                    :selectedValue="
                                        form.is_show_sorting == 1 ? true : false
                                    "
                                    @click="handleIsShowSorting()"
                            ...
                            <div class="flex justify-between">
                                <ps-label class="text-base">
                                    {{
                                        $t(
                                            "core__custom_enable_shown_in_table_for_field_label"
                                        )
                                    }}</ps-label
                                >
                                <ps-toggle
                            ...
                            <div
                                v-if="form.is_include_in_hideshow"
                                class="flex justify-between"
                            >
                                <ps-label class="text-base">
                                    {{
                                        $t(
                                            "core__custom_enable_shown_in_table_label"
                                        )
                                    }}</ps-label
                                >
                                <ps-toggle
                                    :selectedValue="
                                        form.is_show == 1 ? true : false
                                    "
                                    :disabled="
                            ...
                            >
                                <ps-label class="text-base">
                                    {{
                                        $t(
                                            "core__custom_is_show_in_filter_label"
                                        )
                                    }}</ps-label
                                >
                                <ps-toggle
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function submit() {
            ...
            if (language_update_modal_name.value.form.values.length == 0) {
                ...
                for (
                    let i = 0;
                    i < language_update_modal_name.value.form.values.length;
                    i++
                ) {
                    if (
                        language_update_modal_name.value.form.values[i]?.value
                            .length !== 0
                    ) {
                        hasvalue = true;
                        break;
            ...
            if (
                language_update_modal_placeholder.value.form.values.length == 0
            ) {
                ...
                for (
                    let i = 0;
                    i <
                    language_update_modal_placeholder.value.form.values.length;
                    i++
                ) {
                    if (
                        language_update_modal_placeholder.value.form.values[i]
                            ?.value.length !== 0
                    ) {
            ...
            this.$inertia.post(
                route("tables.fields.store", [props.selectedClientTable.id]),
                useForm({
                    nameForm: language_update_modal_name.value.form,
                    form: form,
                    placeholderForm:
                        language_update_modal_placeholder.value.form,
                }),
                {
                    forceFormData: true,
                    onBefore: () => {
                        ...
                        ps_loading_circle_dialog.value.openModal(
                            trans("core__be_custom_creating_title"),
                            trans("core__be_custom_creating_message")
                        );
                    },
                    onSuccess: () => {
                        loading.value = false;
        ...
        function showSuccessDialog(msg) {
            ...
            ps_success_dialog.value.openModal(
                ...
                msg,
                trans("core__be_btn_back_to_list"),
                () => {
                    this.$inertia.get(
                        route("tables.fields.index", [
                            this.selectedClientTable.id,
                        ]),
                        {
        ...
        function nameLanguageClicked(key) {
            if (
                language_update_modal_name.value.languageStrings.data.length ==
                0
            ) {
                props.languages.forEach((language) => {
                    ...
                    language_update_modal_name.value.languageStrings.data.push(
                        languageStringObj
                    );
                });
            }
            ...
            language_update_modal_name.value.openModal(
                key,
                (form) => {
                    validiteName.value = false;
                    const symbol = localStorage.activeLanguage
                        ? localStorage.activeLanguage
                        : "en";
        ...
        function placeholderLanguageClicked(key) {
            if (
                language_update_modal_placeholder.value.languageStrings.data
                    .length == 0
            ) {
                props.languages.forEach((language) => {
                    let languageStringObj = {};
                    ...
                    language_update_modal_placeholder.value.languageStrings.data.push(
                        languageStringObj
                    );
                });
            }
            if (language_update_modal_placeholder.value.form.key == "") {
                language_update_modal_placeholder.value.form.key =
                    "_placeholder";
            }
            language_update_modal_placeholder.value.openModal(
                key,
                (form) => {
    ...
    methods: {
        handleCancel() {
            this.$inertia.get(
                route("tables.fields.index", [this.selectedClientTable.id]),
                {
                    symbol: localStorage.activeLanguage
                        ? localStorage.activeLanguage
                        : "en",
