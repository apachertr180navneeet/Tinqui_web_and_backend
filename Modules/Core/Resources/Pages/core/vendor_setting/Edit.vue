                ...
                <form @submit.prevent="handleSubmit(this.backend_setting.id)">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
                        <div>
                            ...
                            >
                                <div class="px-4 pt-3">
                                    <div class="flex items-center">
                                        <ps-checkbox-value
                                            v-model:value="form.vendor_setting"
                                            class="font-normal"
                                            :title="
                                                $t(
                                                    'core__be_is_vendor_feature_on'
                                                )
                                            "
                                        />
                                        <ps-tooltip
                                ...
                                <div class="px-4 pb-3">
                                    <ps-label
                                        ...
                                        >{{
                                            $t(
                                                "core__be_vendor_feature_on_off_desc"
                                            )
                                        }}</ps-label
                                    >
                                </div>
                            ...
                            <!-- <div class="grid grid-rows gap-6 ms-4" v-if="title == settingColumn[1].label">
                                <ps-card class="w-full h-auto">
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ["errors", "status", "backend_setting"],
    setup(props) {
        ...
        function handleFeLangRefresh() {
            this.$inertia.get(
                route("vendor_setting.languageRefresh"),
                { key: "refresh" },
                {
                    onBefore: () => {
