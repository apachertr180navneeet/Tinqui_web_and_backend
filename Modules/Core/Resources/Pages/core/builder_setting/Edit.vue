                                ...
                                <div v-if="title == settingColumn[0].label">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <ps-input-with-right-icon
                                            ...
                                            :placeholder="
                                                $t('core_be__api_token')
                                            "
                                            theme="pe-12 dark:bg-secondaryDark-black text-secondary-700 dark:text-secondary-700 dark:border-secondary-800"
                                            rounded="rounded"
                                            @keyup="
                                                validateEmptyInput(
                                                    'token',
                                    ...
                                    <div class="px-4 py-3">
                                        <ps-label
                                            class="text-base flex flex-row"
                                            >{{
                                                $t("core_be__guide_link")
                                            }}</ps-label
                                        >
                                        <a
                                            href="https://www.docs.tinqui.ch/mpc/setup/setup-admin-panel/setup-your-own-api-token"
                                            target="_blank"
                                            class="underline underline-offset-2 text-primary-500 mt-2 inline-block cursor-pointer"
                                            >{{
                                                $t(
                                                    "core_be__create_and_update_api_token"
                                                )
                                            }}</a
                                        >
                                    </div>
