    ...
    <ps-layout>
        ...
        >
            <template #button>
                ...
                >
                    <ps-icon name="plus" class="me-1 font-semibold" />
                ...
                <div class="mx-5 mt-6">
                    <div class="w-full">
                        ...
                        >
                            ...
                            <ps-text-button :class="categoryId == '' ? 'bg-primary-100 rounded-t-md': ''" @click="clickCategory('')" class="w-full h-full p-4 cursor-pointer flex flex-row items-center justify-center">
                                ...
                                >
                                    <ps-text-button
                                        ...
                                        class="mx-1 w-auto p-4 cursor-pointer h-full flex flex-row items-center justify-center"
                                    >
                                        <ps-label
                                            :textColor="
                                                categoryId == category.id
                                        ...
                                        <ps-label
                                            ...
                                            class="ms-1 text-xs px-1 py-0.5 bg-white rounded-full min-w-[20px]"
                            ...
                            <div
                                :class="
                                    'splide__arrows splide__arrows--' + getDir()
                                "
                            >
                                <button
            ...
            <template #tableActionRow="rowProps">
                <div class="flex flex-row" v-if="rowProps.field == 'action'">
                    ...
                    <ps-button
                        :disabled="!rowProps.row.authorizations.delete"
            ...
            <template #tableRow="rowProps">
                ...
                <div v-if="rowProps.field == 'status' && reRenderToogle">
                    <ps-toggle
                        ...
                        @click="
                            handlePublish(
                                rowProps.row.id,
                                rowProps.row.authorizations.update
                            )
                        "
                    ></ps-toggle>
                ...
                <ps-text-button
                    :disabled="!can.createItem"
                    v-if="rowProps.field == 'duplicate'"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function getDir() {
            if (
                localStorage.activeLanguage != null &&
    ...
    methods: {
        ...
        FilterOptionshandle(value) {
            router.put(
                route("item.screenDisplayUiSetting.store"),
                {
                    value,
