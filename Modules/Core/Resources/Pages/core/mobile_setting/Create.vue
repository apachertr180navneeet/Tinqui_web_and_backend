                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
                        <div>
                            ...
                            >
                                ...
                                <div>
                                    <ps-label-header-4>{{
                                        $t("core_mb_setting_common_color")
                                    }}</ps-label-header-4>
                                    <div class="grid grid-cols-2">
                                        <div
                                            v-for="common_color in form.commonColor"
                                            :key="common_color.id"
                                        >
                                            <div class="flex flex-row p-1">
                                                <div
                                                    class="w-6 h-6 m-1 rounded shadow-sm cursor-pointer"
                                                >
                                                    <div
                                                        @click="
                                                            colorPickerClicked(
                                                        ...
                                                        "
                                                        class="w-6 h-6 rounded shadow-sm cursor-pointer"
                                                        :style="{
                                                            'background-color':
                                                                common_color.value,
                                                        }"
                                ...
                                <div>
                                    <ps-label-header-4>{{
                                        $t("core_mb_setting_light_color")
                                    }}</ps-label-header-4>
                                    <div class="grid grid-cols-2">
                                        <div
                                            v-for="light_color in form.lightColor"
                                            :key="light_color.id"
                                        >
                                            <div class="flex flex-row p-1">
                                                <div
                                ...
                                <div>
                                    <ps-label-header-4>{{
                                        $t("core_mb_setting_dark_color")
                                    }}</ps-label-header-4>
                                    <div class="grid grid-cols-2">
                                        <div
                                            v-for="dark_color in form.darkColor"
                                            :key="dark_color.id"
                                        >
                                            <div class="flex flex-row p-1">
                                                <div
...
export default defineComponent({
    ...
    methods: {
        handleSubmit() {
            this.$inertia.post(route("mobile_setting.store"), this.form, {
                forceFormData: true,
            });
        },
    },
