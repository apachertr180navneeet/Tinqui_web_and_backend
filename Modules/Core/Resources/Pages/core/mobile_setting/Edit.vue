                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
                        <div>
                            <div
                                ...
                                v-if="title == settingColumn[0].label"
                            >
                                <div>
                                    <ps-label class="text-base">{{
                                        $t("core_mb_setting_google_play_url")
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.google_playstore_url
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_google_play_url'
                                            )
                                        "
                                    />
                                </div>
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t("core_mb_setting_app_store_url")
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="form.apple_appstore_url"
                                        :placeholder="
                                            $t('core_mb_setting_app_store_url')
                                        "
                                    />
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t("core_mb_setting_ios_store_id")
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="form.ios_appstore_id"
                                        :placeholder="
                                            $t('core_mb_setting_ios_store_id')
                                        "
                                    />
                            ...
                            <div
                                class="grid grid-rows gap-6 ms-4 me-18"
                                v-if="title == settingColumn[1].label"
                            >
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_item_detail_view_count_for_ads"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.item_detail_view_count_for_ads
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_item_detail_view_count_for_ads'
                                ...
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_AdMob_setting_on'
                                            )
                                        "
                                        v-model:value="form.is_show_admob"
                                    />
                                </div>
                                ...
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_is_show_admob_inside_item'
                                            )
                                        "
                                        v-model:value="
                                            form.is_show_ads_in_item_detail
                                        "
                                    />
                                </div>
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_android_admob_banner_ad_unit_id"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.android_admob_banner_ad_unit_id
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_android_admob_banner_ad_unit_id'
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_android_admob_native_unit_id"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.android_admob_native_unit_id
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_android_admob_native_unit_id'
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_android_admob_interstitial_ad_unit_id"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.andorid_admob_interstitial_ad_unit_id
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_android_admob_interstitial_ad_unit_id'
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_ios_admob_banner_ad_unit_id"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.ios_admob_banner_ad_unit_id
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_ios_admob_banner_ad_unit_id'
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_ios_admob_native_unit_id"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.ios_admob_native_ad_unit_id
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_ios_admob_native_unit_id'
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t(
                                            "core_mb_setting_ios_admob_interstitial_ad_unit_id"
                                        )
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.ios_admob_interstitial_ad_unit_id
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_ios_admob_interstitial_ad_unit_id'
                            ...
                            >
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t('core_mb_setting_main_menu_on')
                                        "
                                        v-model:value="form.show_main_menu"
                                    />
                                    <ps-label-caption
                                        textColor="text-secondary-400 mt-1"
                                        >{{
                                            $t(
                                                "core_mb_setting_main_menu_on_info"
                                            )
                                        }}</ps-label-caption
                                    >
                                </div>
                                ...
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_featured_items_on'
                                            )
                                        "
                                        v-model:value="form.show_featured_items"
                                    />
                                    <ps-label-caption
                                        textColor="text-secondary-400 mt-1"
                                        >{{
                                            $t(
                                                "core_mb_setting_featured_items_on_info"
                                            )
                                        }}</ps-label-caption
                                    >
                                </div>
                            ...
                            >
                                <div>
                                    <ps-label>{{
                                        $t("core_mb_setting_version_no")
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="form.version_no"
                                        :placeholder="
                                            $t('core_mb_setting_version_no')
                                        "
                                    />
                                ...
                                <div>
                                    <ps-label>{{
                                        $t("core_mb_setting_version_title")
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="form.version_title"
                                        :placeholder="
                                            $t('core_mb_setting_version_title')
                                        "
                                    />
                                ...
                                <div>
                                    <ps-label>{{
                                        $t("core_mb_setting_version_message")
                                    }}</ps-label>
                                    <ps-textarea
                                        rows="4"
                                        v-model:value="form.version_message"
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_version_message'
                                            )
                                        "
                                    ></ps-textarea>
                                </div>
                                ...
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_version_force_update'
                                            )
                                        "
                                        v-model:value="
                                            form.version_force_update
                                        "
                                    />
                                </div>
                                ...
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_version_need_clear_data'
                                            )
                                        "
                                        v-model:value="
                                            form.version_need_clear_data
                                        "
                                    />
                                </div>
                            ...
                            >
                                ...
                                <div>
                                    <ps-label
                                        textColor="text-lg font-semibold text-feSecondary-800"
                                        >{{
                                            $t("core_be__primary_colors")
                                        }}</ps-label
                                    >
                                    <div class="mt-3">
                                        <ps-color-series-generator
                                            :activeColor="primaryColors"
                                            :title="$t('core_be__primary')"
                                            @generated-color="getGeneratedColor"
                                        />
                                    </div>
                                    <div class="mt-10">
                                        <ps-color-series-generator
                                            :activeColor="textColors"
                                            :title="$t('core_be__text')"
                                            @generated-color="getGeneratedColor"
                                        />
                                    </div>
                                    <div class="mt-10">
                                    ...
                                    <div class="mt-10">
                                        <div
                                            class="flex gap-2 items-center py-2 cursor-pointer w-40"
                                            @click="advancedOptionsClick()"
                                        >
                                            <ps-icon
                                            ...
                                            />
                                            <ps-label
                                                textColor="text-primary-500 text-sm font-medium"
                                                >{{
                                                    $t(
                                                        "core_be__advanced_options"
                                                    )
                                                }}</ps-label
                                            >
                                        </div>
                                        ...
                                        >
                                            <ps-label
                                                textColor="text-lg font-semibold text-feSecondary-800 mt-6"
                                                >{{
                                                    $t("core_be__semantics")
                                                }}</ps-label
                                            >
                                            <div class="mt-3">
                                                <ps-color-series-generator
                                                    :activeColor="successColors"
                                                    :title="
                                                        $t('core_be__success')
                                                    "
                                                    @generated-color="
                                            ...
                                            <div class="mt-10">
                                                <ps-color-series-generator
                                                    :activeColor="infoColors"
                                                    :title="$t('core_be__info')"
                                                    @generated-color="
                                                        getGeneratedColor
                                                    "
                                                />
                                            ...
                                            <div class="mt-10">
                                                <ps-label
                                                    ...
                                                    >{{
                                                        $t(
                                                            "core_be__brand_colors"
                                                        )
                                                    }}</ps-label
                                                >
                                                <div
                                                    class="flex flex-wrap gap-y-6 mt-6"
                                                >
                                                    <div
                                                    ...
                                                    >
                                                        <span
                                                            class="block w-20 h-12 cursor-pointer"
                                                            :style="{
                                                                background:
                                                                    brand.value,
                                                            }"
                                                        ></span>
                                                        <ps-label
                                                            textColor="text-xs text-feSecondary-800 text-center capitalize"
                                                            >{{
                                                                brand.key.split(
                                                                    "_"
                                                                )[1]
                            ...
                            >
                                ...
                                <div class="">
                                    <ps-label class="text-base"
                                        >{{
                                            $t(
                                                "core_mb_setting_data_config_data_source_type"
                                            )
                                        }}
                                    </ps-label>
                                    <ps-dropdown
                                    ...
                                    >
                                        <template #select>
                                            <ps-dropdown-select
                                                :selectedValue="
                                                    form.data_config_data_source_type ==
                                                    ''
                                                        ? ''
                                                        : form.data_config_data_source_type
                                                "
                                ...
                                <div>
                                    <ps-label class="text-base">{{
                                        $t("core_mb_setting_data_config_day")
                                    }}</ps-label>
                                    <ps-input
                                        type="text"
                                        v-model:value="form.data_config_day"
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_data_config_day'
                                            )
                                        "
                                        @keypress="onlyNumber"
                                    />
                            ...
                            >
                                <div>
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_is_slider_autoplay'
                                            )
                                        "
                                        v-model:value="form.is_slider_auto_play"
                                    />
                                </div>
                                <div>
                                    <ps-label class="text-base"
                                        >{{
                                            $t(
                                                "core_mb_setting_slider_autoplay"
                                            )
                                        }}
                                    ...
                                    <ps-input
                                        type="text"
                                        v-model:value="form.auto_play_interval"
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_slider_autoplay'
                                            )
                            ...
                            <div
                                class="grid grid-rows gap-6 ms-4 me-18"
                                v-if="title == settingColumn[7].label"
                            >
                                <div>
                                ...
                                <div>
                                    ...
                                    <ps-label-caption
                                        ...
                                        >{{
                                            $t(
                                                "core_mb_setting_date_format_ex"
                                            )
                                        }}dd for the day, MM for the month, yyyy
                                        for the year, hh for the hour, mm for
                                        the minute, ss for the second (e.g.
                                        dd-MM-yyyy hh:mm:ss)</ps-label-caption
                                    >
                                </div>
                                ...
                                <div class="flex items-center">
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_use_google_map_on'
                                            )
                                        "
                                        v-model:value="form.is_use_google_map"
                                    />
                                    <ps-tooltip
                                ...
                                <div class="flex items-center">
                                    <ps-checkbox-value
                                        :title="
                                            $t(
                                                'core_mb_setting_is_language_config'
                                            )
                                        "
                                        v-model:value="form.is_language_config"
                                    />
                                    <ps-tooltip
                                        tooltiptext="absolute z-50 bottom-full mb-2 -ms-2.5"
                                    >
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <ps-label class="text-base">{{
                                            $t(
                                                "core_mb_setting_item_loading_cell_count"
                                            )
                                        }}</ps-label>
                                        <ps-tooltip
                                            tooltiptext="absolute z-50 bottom-full ms-0.5"
                                    ...
                                    <ps-input
                                        type="text"
                                        v-model:value="
                                            form.loading_shimmer_item_count
                                        "
                                        :placeholder="
                                            $t(
                                                'core_mb_setting_item_loading_cell_count'
                            ...
                            <div class="flex flex-row justify-end mt-6 mb-2.5">
                                ...
                                <ps-button
                                    :disabled="
                                        !mobile_setting.authorizations.update
                                    "
...
const PsColorPickerModal = defineAsyncComponent(() =>
    import("@/Components/Core/Modals/PsColorPickerModal.vue")
);
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function getGeneratedColor(color) {
            color.forEach((col) => {
                mobileColors.value.filter((mc) => mc.id == col.id)[0].value =
                    col.value;
            });
        ...
        const primaryColors = ref(
            props.mobileColors.filter((mb) => mb.title == "primary")
        );
        const textColors = ref(
            props.mobileColors.filter((mb) => mb.title == "text")
        );
        const accentColors = ref(
            props.mobileColors.filter((mb) => mb.title == "accent")
        );
        const successColors = ref(
            props.mobileColors.filter((mb) => mb.title == "success")
        );
        const errorColors = ref(
            props.mobileColors.filter((mb) => mb.title == "error")
        );
        const warningColors = ref(
            props.mobileColors.filter((mb) => mb.title == "warning")
        );
        const infoColors = ref(
            props.mobileColors.filter((mb) => mb.title == "info")
        );
        const achromaticColors = ref(
            props.mobileColors.filter((mb) => mb.title == "achromatic")
        );
        const brandColors = ref(
            props.mobileColors.filter((mb) => mb.title == "brand")
        );
        ...
        function brandClick(data) {
            ps_color_picker_modal.value.openModal(
                ...
                (selectedColor) => {
                    ...
                    mobileColors.value.filter(
                        (mc) => mc.id == data.id
                    )[0].value = selectedColor;
                    form.mobileColors = JSON.stringify(mobileColors.value);
    ...
    methods: {
        handleSubmit(id) {
            this.$inertia.post(route("mobile_setting.update", id), this.form, {
                forceFormData: true,
            });
        },
    },
