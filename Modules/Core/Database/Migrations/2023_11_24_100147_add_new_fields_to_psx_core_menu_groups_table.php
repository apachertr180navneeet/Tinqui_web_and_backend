...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('core_menu_groups')->where('id','=', 2)->update(['ordering' => 4]);
        DB::table('core_menu_groups')->where('id','=', 3)->update(['ordering' => 5]);
        ...
        DB::table('core_sub_menu_groups')->where('id','=', $coreSubMenuGroup->id)->update(['module_id' => $module->id]);
        ...
        DB::table('modules')->where('id','=', $module->id)->update(['menu_id' => $coreMenu->id]);
    ...
    {
        Schema::table('core_menu_groups', function (Blueprint $table) {
