...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if ($frontendSetting) {
            ...
            // Handle the case where no FrontendSetting instance is found
            // You could log an error or handle it as needed
            \Log::error('No FrontendSetting instance found');
        }
    }
