...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('vendor_roles')->truncate();
        DB::table('vendor_role_permissions')->truncate();
        DB::table('vendor_modules')->truncate();
        // DB::table('vendor_user_permissions')->truncate();
        ...
        DB::table('vendor_role_permissions')->insert([
            'id' => 1,
            'vendor_role_id' => 1,
        ...
        DB::table('vendor_modules')->insert([
            'id' => 'ps-0000000001',
        ...
        $myStoreIconId = DB::table('icons')->insertGetId([
            'icon_name' => 'myStore',
            'added_date' => Carbon::now(),
            'added_user_id' => '1',
        ]);
        ...
        DB::table('vendor_modules')->where('id','=','ps-0000000001')->update(['sub_menu_id' => $soteSubMenu->id]);
        ...
        DB::table('vendor_modules')->where('id','=','ps-0000000002')->update(['menu_id' => $menu->id]);
