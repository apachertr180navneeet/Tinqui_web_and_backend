...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $vendor_menu_group_module = DB::table('modules')->where('lang_key','=','vendor_menu_group_module')->first();
        $vendor_sub_menu_group_module = DB::table('modules')->where('lang_key','=','vendor_sub_menu_group_module')->first();
        $vendor_menu_module = DB::table('modules')->where('lang_key','=','vendor_menu_module')->first();
        $vendor_module_registering_module = DB::table('modules')->where('lang_key','=','vendor_module_registering_module')->first();
        $vendor_role_module = DB::table('modules')->where('lang_key','=','vendor_role_module')->first();

        if(empty($vendor_menu_group_module)){
            $vendor_menu_group_module_id = DB::table('modules')->insertGetId([
                'id' => 77,
        ...
        if(empty($vendor_sub_menu_group_module)){
            $vendor_sub_menu_group_module_id = DB::table('modules')->insertGetId([
                'id' => 78,
        ...
        if(empty($vendor_menu_module)){
            $vendor_menu_module_id = DB::table('modules')->insertGetId([
                'id' => 79,
                'title' => 'vendor_menu',
        ...
        if(empty($vendor_module_registering_module)){
            $vendor_module_registering_module_id = DB::table('modules')->insertGetId([
                'id' => 80,
        ...
        if(empty($vendor_role_module)){
            $vendor_role_module_id = DB::table('modules')->insertGetId([
                'id' => 81,
                'title' => 'vendor_role',
        ...
        if(empty($vendor_menu_group)){
            ...
            DB::table('modules')->where('id','=',$vendor_menu_group_module_id)->update(['menu_id' => $menu->id]);
        }
        if(empty($vendor_sub_menu_group)){
            ...
            DB::table('modules')->where('id','=',$vendor_sub_menu_group_module_id)->update(['menu_id' => $menu->id]);
        }
        if(empty($vendor_menu)){
            ...
            DB::table('modules')->where('id','=',$vendor_menu_module_id)->update(['menu_id' => $menu->id]);
        }
        if(empty($vendor_module_registering)){
            ...
            DB::table('modules')->where('id','=',$vendor_module_registering_module_id)->update(['menu_id' => $menu->id]);
        }
        if(empty($vendor_role)){
            ...
            DB::table('modules')->where('id','=',$vendor_role_module_id)->update(['menu_id' => $menu->id]);
        }
