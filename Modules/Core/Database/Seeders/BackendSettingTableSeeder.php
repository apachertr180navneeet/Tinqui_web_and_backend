...
class BackendSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('backend_settings')->insert([
            'sender_name' => 'Team PS',
            'sender_email' => 'sender@blog.tinqui.ch',
            ...
            'dyn_link_package_name' => 'com.Tinqui.flutterbuyandsell',
            'dyn_link_domain' => 'buysell1.page.link',
            'dyn_link_deep_url' => 'https://tinqui.ch//buysell-fe-dev/item/',
            'ios_boundle_id' => 'com.Tinqui.flutterbuyandsell',
