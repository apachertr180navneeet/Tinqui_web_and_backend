...
class UserApiResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if(isset($this->code) && $this->code != '' && $this->code != null){
            $has_code = '1';
        }else{
            $has_code = '0';
        }
        ...
        return [
            ...
            //  'phone' => isset($this->phone)?(string)$this->phone:'',
              'state' => isset($this->state)?(string)$this->state:'',
            'city' => isset($this->city)?(string)$this->city:'',
               'country' => isset($this->country)?(string)$this->country:'',
