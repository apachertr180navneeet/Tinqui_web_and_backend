...
class ProductApiResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'is_auction_item' => isset($this->is_auction_item)?(integer)$this->is_auction_item:'',
            'auction_status' => isset($this->auction_status)?(integer)$this->auction_status:'',
            'jitsi_token' => isset($this->jitsi_token)?(string)$this->jitsi_token:'',
            'is_warranty_item' => isset($this->is_warranty_item)?(integer)$this->is_warranty_item:'0',
            'preferred_payment' => isset($this->preferred_payment)?(string)$this->preferred_payment:'wallet',
            'auction_period' => isset($this->auction_period)?(string)$this->auction_period:'',
            'product_creation_date' => isset($this->product_creation_date)?(string)$this->product_creation_date:'',
            'is_expired' => isset($this->is_expired)?(string)$this->is_expired:'',
            'highest_bid_price'=> isset($this->highest_bid_price)?(string)$this->highest_bid_price:'',
            'commission'=> isset($this->commission)?(string)$this->commission:'',
