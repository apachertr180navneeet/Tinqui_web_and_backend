...
class SubcategoryApiController extends Controller
{
    ...
    public function getSubcategories(Request $request)
    {
        ...
        // $subcategories = $this->subCategoryService->getSubCategoriesbyCat($request);
          $subcategories = $this->subCategoryService->getSubCategoriesbyCat($request->cat_id,$request->limit,$request->offset);
