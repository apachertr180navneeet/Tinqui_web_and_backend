...
class MobileLanguageApiController extends Controller
{
    ...
    public function langs(Request $request)
    {
        ...
        $fe_import = file_get_contents(base_path('/Modules/Template/FETemplate/Resources/frontend_languages/'.$request->symbol.'.json'));
        ...
        if (!$fe_import) {
            $fe_import = file_get_contents(base_path('/Modules/Template/FETemplate/Resources/frontend_languages/en.json'));
        }
        if (!$vendor_import) {
