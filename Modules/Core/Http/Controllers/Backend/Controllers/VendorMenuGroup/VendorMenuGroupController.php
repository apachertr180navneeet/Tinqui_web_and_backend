...
class VendorMenuGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('group_name',$coreFieldsIds)){
            $validationArr['group_name'] = 'required|min:3|unique:vendor_menu_groups,group_name,';
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(in_array('group_name',$coreFieldsIds)){
            $validationArr['group_name'] = 'required|min:3|unique:vendor_menu_groups,group_name,'.$id;
        }
