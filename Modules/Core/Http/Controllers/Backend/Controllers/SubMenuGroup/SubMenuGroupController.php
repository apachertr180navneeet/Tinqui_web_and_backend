...
class SubMenuGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('sub_menu_name',$coreFieldsIds)){
            $validationArr['sub_menu_name'] = 'required|min:3|unique:core_sub_menu_groups,sub_menu_name,';
        }
...
//    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(in_array('sub_menu_name',$coreFieldsIds)){
            $validationArr['sub_menu_name'] = 'required|min:3|unique:core_sub_menu_groups,sub_menu_name,'.$id;
        }
