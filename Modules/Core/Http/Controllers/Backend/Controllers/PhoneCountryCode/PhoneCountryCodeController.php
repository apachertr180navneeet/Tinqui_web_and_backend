...
class PhoneCountryCodeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('country_name',$coreFieldsIds)){
            $validationArr['country_name'] = 'required|min:3|unique:phone_country_codes,country_name,'.request()->id;
        }
    ...
    public function update(Request $request, $id)
    {
         ...
         if(in_array('country_name',$coreFieldsIds)){
             $validationArr['country_name'] = 'required|min:3|unique:phone_country_codes,country_name,'.$id;
         }
