...
class AvailableCurrencyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('currency_short_form',$coreFieldsIds)){
            $validationArr['currency_short_form'] = 'required|min:3|unique:available_currencies,currency_short_form,';
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(in_array('currency_short_form',$coreFieldsIds)){
            $validationArr['currency_short_form'] = 'required|min:3|unique:available_currencies,currency_short_form,'.$id;
        }
