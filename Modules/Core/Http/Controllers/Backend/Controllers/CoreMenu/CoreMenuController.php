...
class CoreMenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('module_name',$coreFieldsIds)){
            $validationArr['module_name'] = 'required|min:3|unique:core_menus,module_name,';
        }
        ...
        if(in_array('module_desc',$coreFieldsIds)){
            $validationArr['module_desc'] = 'required|unique:core_menus,module_desc';
        }

        if(in_array('module_lang_key',$coreFieldsIds)){
            $validationArr['module_lang_key'] = 'required|unique:core_menus,module_lang_key';
        }

        if(in_array('module_id',$coreFieldsIds)){
            $validationArr['module_id'] = 'required|unique:core_menus,module_id';
        }
...
//    }
    ...
    public function update(Request $request, $moduleId)
    {
        ...
        if(in_array('module_name',$coreFieldsIds)){
            $validationArr['module_name'] = 'required|min:3|unique:core_menus,module_name,'.$moduleId;
        }
        ...
        if(in_array('module_desc',$coreFieldsIds)){
            $validationArr['module_desc'] = 'required|unique:core_menus,module_desc,'.$moduleId;
        }

        if(in_array('module_lang_key',$coreFieldsIds)){
            $validationArr['module_lang_key'] = 'required|unique:core_menus,module_lang_key,'.$moduleId;
        }

        if(in_array('module_id',$coreFieldsIds)){
            $validationArr['module_id'] = 'required|unique:core_menus,module_id,'.$moduleId;
        }
