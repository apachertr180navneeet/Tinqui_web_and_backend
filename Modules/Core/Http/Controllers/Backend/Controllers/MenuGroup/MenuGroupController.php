...
class MenuGroupController extends Controller
{
    ...
    public function __construct(MenuGroupService $menuGroupService, CoreFieldFilterSettingService $coreFieldFilterSettingService)
    {
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('group_name',$coreFieldsIds)){
            $validationArr['group_name'] = 'required|min:3|unique:core_menu_groups,group_name,';
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(in_array('group_name',$coreFieldsIds)){
            $validationArr['group_name'] = 'required|min:3|unique:core_menu_groups,group_name,'.$id;
        }
