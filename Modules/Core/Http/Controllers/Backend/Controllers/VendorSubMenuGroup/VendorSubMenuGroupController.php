...
namespace Modules\Core\Http\Controllers\Backend\Controllers\VendorSubMenuGroup;
...
use Modules\Core\Http\Services\VendorSubMenuGroupService;
use Modules\Core\Http\Requests\StoreVendorSubMenuGroupRequest;
use Modules\Core\Http\Requests\UpdateVendorSubMenuGroupRequest;
use Modules\Core\Http\Services\CoreFieldFilterSettingService;

class VendorSubMenuGroupController extends Controller
{

    const parentPath = "vendor_sub_menu_group/";
    const indexPath = self::parentPath."Index";
    const createPath = self::parentPath."Create";
    const editPath = self::parentPath."Edit";
    const indexRoute = "vendor_sub_menu_group.index";
    const createRoute = "vendor_sub_menu_group.create";
    const editRoute = "vendor_sub_menu_group.edit";

    protected $subMenuGroupService, $successFlag, $dangerFlag, $csvFile, $warningFlag, $code, $coreFieldFilterSettingService;

    public function __construct(VendorSubMenuGroupService $subMenuGroupService, CoreFieldFilterSettingService $coreFieldFilterSettingService)
    {
    ...
    public function store(Request $request)
    {
        ...
        if(in_array('sub_menu_name',$coreFieldsIds)){
            $validationArr['sub_menu_name'] = 'required|min:3|unique:vendor_sub_menus,sub_menu_name,';
        }
...
//    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(in_array('sub_menu_name',$coreFieldsIds)){
            $validationArr['sub_menu_name'] = 'required|min:3|unique:vendor_sub_menus,sub_menu_name,'.$id;
        }
