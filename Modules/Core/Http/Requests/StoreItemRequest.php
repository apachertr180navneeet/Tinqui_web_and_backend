...
class StoreItemRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $validations = array(
            ...
            array(
                'fieldName' => 'title',
                'rules' => 'required|min:3|unique:items,title,' . $this->route('item'),
            ),
            array(
            ...
            array(
                ...
                'rules' => 'required|exists:location_cities,id',
            ),
            array(
                'fieldName' => 'location_township_id',
                'rules' => 'required|exists:location_townships,id',
            ),
            array(
                'fieldName' => 'currency_id',
                'rules' => $selcted_array['selected_price_type']['id'] == "NORMAL_PRICE" ? 'required|exists:currencies,id' : 'nullable',
            ),
            array(
