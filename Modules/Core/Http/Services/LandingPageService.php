...
class LandingPageService extends PsService
{
    ...
    {
        $this->landingPageIdCol = LandingPage::id;
    ...
    public function getLandingPage($id = null){
        $landing_page = LandingPage::with(['landing_logo','landing_cover'])
                                    ->first();
        return $landing_page;
    }
    ...
    public function index(){
        // check permission
        // $checkPermission = $this->checkPermission($this->viewAnyAbility, LandingPage::class, "admin.index");
