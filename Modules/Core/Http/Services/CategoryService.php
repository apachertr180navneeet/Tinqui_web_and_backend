...
//        }
    ...
    public function getFromApi($request){
        ...
        $categories =  Category::orderBy($conds['order_by'], $conds['order_type'])->get();
        foreach($categories as $category)
        {
            $sub_categories =  Subcategory::where('category_id',$category->id)->orderBy($conds['order_by'], $conds['order_type'])->get();
            $category->sub_cats = $sub_categories;
        }
        return $categories;
