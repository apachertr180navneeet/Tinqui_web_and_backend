...
class LanguageService extends PsService
{
    ...
    public function create($request)
    {
        ...
        try {
            ...
            $languageStrings = LanguageString::where($this->langStringLanguageIdCol, $activeLanguage->id)->get();
...
//            }
            ...
            $felanguageStrings = FeLanguageString::where($this->langStringLanguageIdCol, $activeLanguage->id)->get();

            foreach ($felanguageStrings as $languageString){
                $felanguageStringData[] = [
                    'key' => $languageString->key,
                    'value' => $languageString->value,
                    'language_id' => $language->id,
                    'added_user_id' => Auth::id(),
            ...
            FeLanguageString::insert($felanguageStringData);
