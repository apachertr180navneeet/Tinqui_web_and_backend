...
class Vendor extends Model
{
    ...
    protected $fillable = ['id', 'name', 'phone', 'email', 'address', 'description', 'website', 'facebook', 'instagram', 'status', 'owner_user_id', 'added_date', 'added_user_id', 'updated_date', 'updated_user_id', 'updated_flag'];
