...
class Item extends Model
{
    ...
    const is_auction_item = 'is_auction_item';
    const auction_ids = 'auction_ids';
    const auction_price = 'auction_price';
    const auction_status = 'auction_status';
    const is_warranty_item = 'is_warranty_item';
    const preferred_payment = 'preferred_payment';
    const auction_period = 'auction_period';
    const product_creation_date = 'product_creation_date';
    ...
    public function vendor(){
        return $this->belongsTo(Vendor::class,"vendor_id","id")->where('vendors.status', Constants::vendorAcceptStatus)->with('logo');
    }
    ...
    public function vendorAuthorization(): Attribute
    {
        ...
        return Attribute::make(
            get: fn ($value) => $this->authorizations(Constants::vendorItemModule, array_keys($params), PsVendorPolicy::class, $params),
        );
    ...
    public function authorization(): Attribute
    {
        ...
        return Attribute::make(
            get: fn ($value) => $this->authorizations(Constants::itemModule, array_keys($params), PsPolicy::class, $params),
        );
    }
}
