<template>
    <div>
        ...
        >
            ...
            <template #footer>
                <ps-label class="ms-8 font-medium text-sm lg:text-base mb-2">
                    {{ $t("promote_item_modal__pay_with") }}
                </ps-label>
                <div class="px-8 flex gap-2 flex-row flex-wrap justify-between">
                    <ps-button
                        colors="bg-feBrand-paypal text-feAchromatic-50"
                        v-if="appInfoStore.appInfo.data?.paypalEnable == '1'"
                        class="w-1/4 py-3"
                        @click="paymentClicked('PAYPAL')"
                        >{{
                            $t("promote_item_modal__pay_with_paypal")
                        }}</ps-button
                    >
                    <ps-button
                    ...
                    >
                    <ps-button
                        colors="bg-feBrand-razor text-feAchromatic-50"
                        v-if="appInfoStore.appInfo.data?.razorEnable == '1'"
                        class="w-1/4 py-3"
                        @click="paymentClicked('RAZOR')"
                        >{{
                            $t("promote_item_modal__pay_with_razor")
                        }}</ps-button
                    >
                    <ps-button
                        colors="bg-feBrand-paystack text-feAchromatic-50"
                        v-if="appInfoStore.appInfo.data?.payStackEnabled == '1'"
                        class="w-1/4 py-3"
                        @click="paymentClicked('PAYSTACK')"
                        >{{
                            $t("promote_item_modal__pay_with_stack")
                        }}</ps-button
                    >
                    <ps-button
                        v-if="appInfoStore.appInfo.data?.offlineEnabled == '1'"
                        class="w-1/4 py-3"
                        @click="paymentClicked('OFFLINE')"
                        >{{
                            $t("promote_item_modal__pay_with_offline")
                        }}</ps-button
                    >
