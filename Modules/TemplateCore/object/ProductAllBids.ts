...
export default class ProductAllBids extends PsObject<ProductAllBids> {
    id: String = "";
    buyer_id: String = "";
    seller_id: String = "";
    bid_price: String = "";
    ...
    toMap(object: ProductAllBids): any {
        const map = {};
    ...
    toMapList(objectList: ProductAllBids[]): any[] {
        const mapList: any[] = [];
    ...
    fromMap(obj: any) {
        return new ProductAllBids().init(
            obj.id,
            obj.buyer_id,
            obj.seller_id,
            obj.bid_price,
    ...
    fromMapList(objList: any[]): ProductAllBids[] {
        const list: ProductAllBids[] = [];
        for (const obj of objList as Array<ProductAllBids>) {
            if (obj != null) {
