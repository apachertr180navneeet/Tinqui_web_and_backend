...
import CategorySubcategory from "@templateCore/object/CategorySubcategory";
...
export const useCategoryStoreState = makeSeparatedStore((key: string) =>
    defineStore(`categoryStore/${key}`, () => {
        ...
        let id: string = "";
        let paramHolder = reactive<CategoryListParameterHolder>(
        ...
        async function loadItemList(
            loginUserId: string,
            holder: CategoryListParameterHolder
        ) {
            loading.value = true;

            const responseData = await PsApiService.getCategoryList<Category>(
                new Category(),
                limit.value,
                offset,
                loginUserId,
        ...
        async function loadCategorieswithSubCategories(
            ...
            const responseData =
                await PsApiService.getCategorywithSubCatList<CategorySubcategory>(
