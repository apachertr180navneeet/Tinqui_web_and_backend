    ...
    return {
        ...
        resolve: {
            alias: {
                ...
                "@template1": "/Modules/Template/FETemplate/Resources/Pages", //path.resolve(__dirname, './Modules/Template/FETemplate/Resources/Pages'),//'Modules/Template/FETemplate/Resources/Pages',
                "@templateCore": "/Modules/TemplateCore", //path.resolve(__dirname, './Modules/TemplateCore'),//'Modules/TemplateCore',
                "@public": "/public",
                "@vendorPanel":
                    "/Modules/StoreFront/VendorPanel/Resources/Pages",
            },
        },
        plugins: [
            {
