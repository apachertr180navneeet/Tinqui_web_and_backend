...
class ps_constant
{
    ...
    const ApiUrl = "https://api.tinqui.com/";
    const ApiVersion = "v3";
    ...
    //const builderDomain = "https://tinqui.ch/";
    ...
    const searchDomain = "https://www.tinqui.ch/";
    const searchSubFolder = "mpc-demo";
    const searchSubFolderWithSlash1 = "/mpc-demo";
    const searchSubFolderWithSlash2 = "mpc-demo/";
