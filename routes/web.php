...
/*************April 11 *****************/
use Modules\Core\Http\Controllers\Backend\Controllers\User\WalletWithdrawController;
use Modules\Core\Http\Controllers\Backend\Controllers\User\DisputesController;
...
//not use route end
  ...
  Route::post('/webhook_url/stripe_connect_webhook',[StripeConnectController::class, 'stripe_connect_webhook']); 
  Route::post('/webhook_url/stripe_main_webhook',[StripeConnectController::class, 'stripe_main_webhook']);
...
/************May 2 Cron JObsbackup for commands incase issues*************************************************************/ 
// Route::get('/item-received', [CronJobController::class, 'automatic_release_funds_after_48_hours']); //per hour
// Route::get('/item-shipped', [CronJobController::class, 'reminder_after_7days_item_shipped']); //per day
// Route::get('/item-shipped-after-reminder', [CronJobController::class, 'reminder_after_10days_item_shipped']); //per day
// Route::get('/auto-cancel-after-48hours', [CronJobController::class, 'auto_cancel_processing_bid_after_48_hours']);  //per hour
...
Route::middleware(['isInstall'])->group(function () {
    ...
    require base_path('Modules/Template/FETemplate/Resources/Pages/vendor/routes/web.php');
    ...
    Route::middleware(["auth", "checkUpdater", "checkDashboardPermission"])->prefix('admin')->group(function () {
        ...
        Route::middleware(["system"])->group(function () {
            ...
            /************Admin Wallet Pages May 06**********************/
            Route::resource('/withdraw_request', WalletWithdrawController::class);
            Route::resource('/disputes', DisputesController::class);  
            //  Route::controller(DisputesController::class)->group(function () {
            //     Route::post('/disputes/update', 'update')->name('disputes.update');
            //  });
