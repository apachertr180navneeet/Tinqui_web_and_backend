            ...
            <div class="w-full mt-6 pt-4">
                <div class="mb-4">
                    ...
                    >
                        <template #icon>
                            ...
                            <ps-icon
                                :name="copied ? 'clipboard-icon' : 'check'"
                                w="24"
                                h="24"
                        ...
                        <div class="w-0 flex-1 flex">
                            ...
                            <div>
                                <h4 class="text-md leading-6 font-medium">
                                    {{
                                        $t(
                                            "setup_connection_with_builder__auto_sync_error_title"
                                        )
                                    }}
                                </h4>
                                <p class="text-sm">
                        ...
                        <div class="w-0 flex-1 flex">
                            ...
                            <div>
                                ...
                                <div class="flex mt-3">
                                    <a
                                        target="_blank"
                                        href="https://www.products.Tinqui.co/Tinqui-Builder-qa/project"
                ...
                <div class="mt-3">
                    ...
                    <ps-button
                        ...
                        class="mb-0.5"
                        padding="px-3 py-2"
                        v-if="upgrade && connect"
                    >
                        <!-- <ps-icon name="plus" class="mx-0.5 font-semibold" /> -->
                        <ps-label textColor="text-white">{{
                            $t("setup_connection_with_builder__upgrade")
                        }}</ps-label>
                    </ps-button>
                </div>
                ...
                router.post(route("admin.dashboard.setupAutoSync"), form, {
                    onBefore: () => {
                        ps_loading_circle_dialog.value.openModal(
                            trans("setup_connection_with_builder__upgrading"),
                            trans("setup_connection_with_builder__wait_msg")
                        );
                        close();
                    },
                    onSuccess: () => {
        ...
        function generateApiKey() {
            ...
            if (form.token == null || form.token == "") {
                router.post(route("api_token.default_creating_token"), form1, {
                    onSuccess: (res) => {
                        form.token = !res.props.defaultBuilderToken
                            ? ""
