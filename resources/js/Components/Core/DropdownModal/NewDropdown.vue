        ...
        <div @click="clicked"  >
            ...
            <transition
                ...
                <div v-if="isMenuOpen"
                    ...
                    :class="[horizontalAlign == 'right' ? 'origin-top-right right-0 rtl:origin-top-left rtl:left-0' : 'origin-top-left left-0 rtl:origin-top-right rtl:right-0',verticalAlign, h]">
