<template>
    <ps-layout>
        ...
        <div>
            ...
            <ps-button class="m-2" btnSize="btn-sm"> Default Button </ps-button>
            <ps-button class="m-2"> Default Button </ps-button>
            <ps-button class="m-2" btnSize="btn-lg"> Default Button </ps-button>
            <ps-button class="m-2" disabled="true"> Disabled Button </ps-button>
            <br />
            ...
            <ps-button class="m-2" theme="btn-info"> Info Button </ps-button>
            <ps-button class="m-2" theme="btn-error"> Error Button </ps-button>
            <ps-button class="m-2" theme="btn-dark"> Dark Button </ps-button>
            <ps-button class="m-2" theme="btn-light"> Light Button </ps-button>
            ...
            <ps-badge class="m-2" theme="badge-error"> Error Badge </ps-badge>
            <ps-badge class="m-2" theme="badge-dark"> Dark Badge </ps-badge>
            <ps-badge class="m-2" theme="badge-light"> Light Badge </ps-badge>
            ...
            <ps-alert>
                <span
                    ...
                    Distinctio nisi rerum qui quibusdam minus adipisci expedita
                    ad ipsam tempore officia. Eligendi possimus neque omnis
                    molestias, enim incidunt earum error natus!</span
                >
            </ps-alert>
            ...
            <ps-line theme="my-5" />
            <ps-label-title class="mt-8"> Datetime Picker UI </ps-label-title>
            ...
            <bar-chart :chartOptions="chartOptions" :chartData="chartData" />
            <pie-chart
...
export default {
    ...
    setup() {
        ...
        function speak() {
            greetingSpeech.text =
                "Hello! Welcome from Tinqui. Your bidding is going to finish. 5, 4, 3, 2, 1. bidding completed. Thanks for using our service. Ended.";
        ...
        const searchOptions = [
            {
                ...
                value: "",
                dropdown_items: gender,
                field: "gender",
            },
            {
                search_type: "dropdown",
                value: "",
                dropdown_items: status,
                field: "status",
            },
