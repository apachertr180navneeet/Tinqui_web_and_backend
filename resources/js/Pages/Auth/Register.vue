<template>
  ...
  <div :class="isDarkMode ? 'dark' : ''">
    <div
      class="mb-6 bg-feAchromatic-50 dark:bg-feAchromatic-900 flex flex-row min-h-screen items-center justify-center">
      <div class="h-auto sm:mt-32 lg:mt-36 mt-28 flex flex-row w-98 lg:w-202 rounded-md overflow-hidden shadow-md"
        style="border: solid 1px #59d759">
        ...
        <div class="w-full lg:w-100 bg-feAchromatic-50 dark:bg-feSecondary-800 px-4 sm:px-10 pb-10">
          ...
          <div class="flex justify-center">
            <ps-label class="mt-6 mb-6 text-2xl font-senibold justify-center">{{ $t("core__fe_register_title")
              }}</ps-label>
          </div>

          <div>
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("core__fe_name") }}<span class="text-red-400">*</span></ps-label>
              ...
              <ps-label class="mt-2 text-xs" textColor=" text-feSecondary-400 dark:text-feSecondary-300">{{
                $t("core__fe_name_descriotion") }}</ps-label>
              <ps-label-caption textColor="text-feError-500 " class="mt-2 block">{{ nameError
                }}</ps-label-caption>
            </div>
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("core__fe_username") }}<span class="text-red-400">*</span></ps-label>
              <ps-input type="text" v-model:value="form.username" @keypress="usernameError = ''"
                ...
                :placeholder="$t('core__fe_username_placeholder')
                  " />
              <ps-label class="mt-2 text-xs" textColor=" text-feSecondary-400 dark:text-feSecondary-300">{{
                $t("username__fe_valid_description")
              }}</ps-label>
            ...
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("core__fe_email") }}<span class="text-red-400">*</span></ps-label>
              <ps-input type="email" v-model:value="form.email" @keypress="emailError = ''"
                class="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                theme="text-feSecondary-500 dark:bg-feSecondary-800"
                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
                :placeholder="$t('core__fe_email_placeholder')" />
              <ps-label-caption textColor="text-feError-500 " class="mt-2 block">{{ emailError
                }}</ps-label-caption>
            </div>
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("core__fe_user_phone") }}<span class="text-red-400">*</span></ps-label>
              <div class="flex">
                <input type="text" disabled class="block bg-transparent w-[50px] px2 py-2 text-sm shadow-sm dark:placeholder-feAchromatic-600 placeholder-feAchromatic-200
                                          text-feSecondary-500 dark:bg-feSecondary-800 placeholder-feSecondary-800 dark:placeholder-feSecondary-500
                                          ...
                                          " value="+41" />
                <ps-input type="tel" maxlength=10 v-model:value="form.phone" @keypress="phoneError = ''"
                  class="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                  theme="text-feSecondary-500 dark:bg-feSecondary-800"
                  defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400" />
              </div>
            ...
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("credit_card_view__city") }}<span class="text-red-400">*</span></ps-label>
              <ps-input type="text" v-model:value="form.city" @keypress="cityError = ''"
                class="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                theme="text-feSecondary-500 dark:bg-feSecondary-800"
                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
                :placeholder="$t('credit_card_view__city_placeholder')" />
              <ps-label-caption textColor="text-feError-500 " class="mt-2 block">{{ cityError
                }}</ps-label-caption>
            </div>
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("credit_card_view__state") }}<span class="text-red-400">*</span></ps-label>
              <ps-input type="text" v-model:value="form.state" @keypress="stateError = ''"
                class="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                theme="text-feSecondary-500 dark:bg-feSecondary-800"
                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
                :placeholder="$t('credit_card_view__state')" />
              <ps-label-caption textColor="text-feError-500 " class="mt-2 block">{{ stateError
                }}</ps-label-caption>
            </div>
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("country_placeholder") }}<span class="text-red-400">*</span></ps-label>
              <ps-input type="text" v-model:value="form.country" disabled
                class="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                theme="text-feSecondary-500 dark:bg-feSecondary-800"
                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
            ...
            <div class="mb-4">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("core__fe_password") }}<span class="text-red-400">*</span></ps-label>
              <ps-input-with-right-icon v-model:value="form.password" ref="password" @keypress="pswError = ''"
                ...
                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
                :type="isHide ? 'password' : 'text'" :placeholder="$t('core__fe_password_placeholder')
                  " autocomplete="current-password">
                <template #icon>
                  <ps-icon @click="isHide = !isHide" class="cursor-pointer" :name="isHide ? 'eyeOff' : 'eye-on'" />
                </template>
              </ps-input-with-right-icon>
              <ps-label-caption textColor="text-feError-500 " class="mt-2 block">{{ pswError
                }}</ps-label-caption>
            </div>
            <div class="mb-8">
              <ps-label class="mb-2" textColor="text-feSecondary-800 dark:text-feSecondary-200">{{
                $t("core__fe_conf_password") }}<span class="text-red-400">*</span></ps-label>
              <ps-input-with-right-icon v-model:value="form.password_confirmation" ref="conf_password"
                @keypress="confpswError = ''"
                placeholderColor="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                theme="bg-feAchromatic-50 dark:bg-feSecondary-800"
                defaultBorder="border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50 focus:outline-none focusr_border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400"
                :type="isHide1 ? 'password' : 'text'" :placeholder="$t('core__fe_conf_password_placeholder')
                  " autocomplete="current-password">
                <template #icon>
                  <ps-icon @click="isHide1 = !isHide1" class="cursor-pointer" :name="isHide1 ? 'eyeOff' : 'eye-on'" />
                </template>
              </ps-input-with-right-icon>
              <ps-label-caption textColor="text-feError-500 " class="mt-2 block">{{ confpswError
                }}</ps-label-caption>
            </div>

            <div class="flex flex-row items-start justify-start mb-6">
              <ps-checkbox-value title="" class="!block" v-model:value="agreePrivacyPolicy"
              ...
              <ps-label textColor="text-fePrimary-500" class="text-sm">
                {{ $t("login__privacy_policy") }}</ps-label>
            </div>

            <div class="block mt-8">
              <ps-button class="w-full mb-2" @click="submit">
                <ps-loading v-if="loading" theme="border-2 border-t-2 border-text-8 border-t-fePrimary-500 me-1"
                  loadingSize="h-5 w-5" />
  ...
  setup(props) {
      ...
      if (messaging) {
        fetch(
          ...
          topic,
          {
            ...
            headers: new Headers({
              Authorization:
                "key=" + props.backendSetting.fcm_api_key,
            }),
          }
        )
          .then((response) => {
    ...
    async function submit() {
      ...
      if (form.name == "" || form.name == undefined) {
        nameError.value = trans("name_field_error");
        errorStatus = false;
      }

      if (form.username == "" || form.username == undefined) {
        usernameError.value = trans("username_field_error");
        errorStatus = false;
      } else if (!userNameRegex.test(form.username)) {
        usernameError.value = trans("invalid_username_error");
        errorStatus = false;
      }
      if (form.city == "" || form.city == undefined) {
        cityError.value = trans("city_field_error");
        errorStatus = false;
      }
      if (form.state == "" || form.state == undefined) {
        stateError.value = trans("state_field_error");
        errorStatus = false;
      }
      if (form.email == "" || form.email == undefined) {
        emailError.value = trans("email_field_error");
        errorStatus = false;
      } else if (!emailRegex.test(form.email)) {
        emailError.value = trans("invalid_email_error");
        errorStatus = false;
      }
      if (form.phone == "" || form.phone == undefined) {
        phoneError.value = trans("phone_field_error");
        errorStatus = false;
      } else if (!phoneRegex.test(form.phone)) {
        phoneError.value = trans("invalid_phone_error");
        errorStatus = false;
      }

      if (form.password == "" || form.password == undefined) {
        pswError.value = trans("password_field_error");
        errorStatus = false;
      }
      if (
        ...
        confpswError.value = trans("confirm_password_field_error");
        errorStatus = false;
      }

      if (form.password !== form.password_confirmation) {
        confpswError.value = trans("password_not_match_error");
        errorStatus = false;
      }
      ...
      localStorage.headerToken =
        localStorage.deviceToken + currentDate.getTime();
      ...
      paramHolder.city = form.city;
      paramHolder.state = form.state;
      paramHolder.country = form.country;
      paramHolder.phone = "+41-" + form.phone;
      ...
      if (user.status == PsStatus.SUCCESS) {
        if (user.data.needVerify == 1) {
          ...
          const status = await authStore.signInWithEmailAndPassword(
            form.email,
            form.email
          );
          if (status) {
