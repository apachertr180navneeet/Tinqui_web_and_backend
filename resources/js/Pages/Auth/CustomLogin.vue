<template>
    ...
    <div :class="isDarkMode ? 'dark' : ''">
        ...
        >
            <ps-card
                class="w-full sm:max-w-md mt-6 py-4 dark:bg-feSecondary-800"
            >
                <div class="px-6">
                    <ps-label-header-5 class="pt-2 text-center font-semibold">{{
                        $t("core_fe_create_account")
                    }}</ps-label-header-5>
                    ...
                    <form class="mt-6" @submit.prevent="submit">
                        <div
                            class="mb-4"
                            v-if="userLoginData.loginMethod == 'phone'"
                        >
                            <ps-label
                                class="mb-2"
                                textColor="text-feSecondary-800 dark:text-feSecondary-200"
                                >{{ $t("core__fe_user_phone") }}</ps-label
                            >
                            <ps-input
                                ref="phone"
                                type="text"
                                ...
                                :placeholder="$t('core__fe_phone_placeholder')"
                                :disabled="true"
                            />
                            <ps-label-caption
                        ...
                        <div class="mb-4">
                            <ps-label
                                class="mb-2"
                                textColor="text-feSecondary-800 dark:text-feSecondary-200"
                                >{{ $t("core__fe_username") }}</ps-label
                            >
                            <ps-input
                                ref="email"
                                type="text"
                                v-model:value="form.newUser.username"
                                class="placeholder-feSecondary-800 dark:placeholder-feSecondary-500"
                                theme="text-feSecondary-500 dark:bg-feSecondary-800"
                                defaultBorder="border border-feSecondary-200 dark:border-feSecondary-400 focus:outline-none focus:ring-1 focus:ring-fePrimary-500"
                                :placeholder="
                                    $t('core__fe_username_placeholder')
                                "
                                autofocus
                            />
                            <ps-label-title-3
                                class="mt-2"
                                textColor="text-feSecondary-400 dark:text-feSecondary-500"
                                >{{
                        ...
                        <div class="mb-8">
                            <ps-label
                                class="mb-2"
                                textColor="text-feSecondary-800 dark:text-feSecondary-200"
                                >{{ $t("core__fe_password") }}</ps-label
                            >
                            <ps-input-with-right-icon
                                v-model:value="form.newUser.password"
                                ref="password"
    ...
    methods: {
        async submit() {
            ...
            if (this.form.loginMethod == "phone") {
                ...
                this.paramHolder.name = this.form.name
                    ? this.form.name
                    : this.form.username;
            }
            this.paramHolder.email = this.form.email;
            this.paramHolder.profile_photo_url = this.form.profile_photo_url
            ...
            const UserLogindata = await this.authStore.createUserwithUsername(
                this.paramHolder
            );
