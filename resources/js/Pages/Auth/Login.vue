<template>
    ...
    <div :class="isDarkMode ? 'dark' : ''" :dir="getDir()">
        <!-- frontend enable -->
        <PsFrontendLayout
            v-if="backendSetting.fe_setting == 1"
        ...
        >
            ...
            >
                ...
                >
                    <div
                        class="hidden w-100 h-auto bg-feSecondary-900 lg:flex flex-col items-center justify-center"
                    >
                        <div class="w-65 h-50">
                            <welcome-image />
                        ...
                        <ps-label
                            ...
                            textColor="text-feSecondary-50"
                        >
                            {{ $t("login__fe_title_best_deal") }}
                        </ps-label>
                        <ps-label
                            class="text-base font-normal text-center mb-2 mx-10"
                            textColor="text-feSecondary-200"
                        >
                            {{ $t("login__fe_description_best_deal") }}
                        </ps-label>

                        <div
                            class="flex flex-row text-feSecondary-50 dark:text-feSecondary-900 rtl:space-x-reverse space-x-4"
                        >
                    ...
                    <div
                        class="w-full lg:w-100 bg-feAchromatic-50 dark:bg-feSecondary-800 px-10 pb-10"
                    >
                        ...
                        <div class="flex justify-center">
                            <ps-label
                                class="mt-6 mb-6 text-2xl font-senibold justify-center"
                                >{{ $t("core__fe_login") }}</ps-label
                            >
                        ...
                        <form @submit.prevent="submit">
                            <div class="mb-4">
                                <ps-label
                                    class="mb-2 text-sm"
                                    textColor="text-feSecondary-800 dark:text-feSecondary-200"
                                    >{{
                                        $t("core__fe_email_username")
                                    }}</ps-label
                                >
                                <ps-input
                                    ref="email"
                                    ...
                                    :placeholder="
                                        $t(
                                            'core__fe_email_username_placeholder'
                                        )
                                    "
                                    autofocus
                                />
                            ...
                            <div class="mb-4">
                                ...
                                <ps-input-with-right-icon
                                    ...
                                    "
                                    :placeholder="
                                        $t('core__fe_password_placeholder2')
                                    "
                                ...
                                <ps-label-caption
                                    textColor="text-feError-500 "
                                    class="mt-2 block"
                                    >{{ errors.password }}</ps-label-caption
                                >
                            </div>
                            ...
                            <ps-label-caption
                                textColor="text-feError-500 "
                                class="mt-2 block"
                                >{{ errors.user_is_bannded }}</ps-label-caption
                            >
                            <ps-label-caption
                                textColor="text-feError-500 "
                                class="mt-2 block"
                                >{{ errors.user_ban }}</ps-label-caption
                            >
                            <ps-label-caption
                                textColor="text-feError-500 "
                                class="mt-2 block"
                                >{{ errors.user_status }}</ps-label-caption
                            >
                        </form>
                        <div class="flex flex-row justify-center my-8">
                            <ps-label
                                class="me-1"
                                textColor="text-feSecondary-800 dark:text-feSecondary-500"
                            >
                        ...
                        <div
                            class="flex flex-row items-start justify-start mb-6"
                        >
                            <ps-checkbox-value
                                title=""
                                v-model:value="agreePrivacyPolicy"
                                color="focus:ring-2 focus:ring-fePrimary-300 hover:bg-fePrimary-500 dark:hover:bg-fePrimary-500 checked:bg-fePrimary-500 dark:checked:bg-fePrimary-500 text-fePrimary-500 dark:text-fePrimary-500"
                                textColor="text-fePrimary-500 dark:text-fePrimary-500"
                        ...
                        <div
                            class="flex flex-row justify-center space-x-3 rtl:space-x-reverse"
                        >
                            <!-- phone -->
                            <div
                                @click="phoneiconclicked"
                                v-if="
                            ...
                            >
                                <svg
                                    class="flex flex-wrap items-center justify-center rtl:space-x-reverse space-x-2 space-y-2 text-feSecondary-50 dark:text-feAchromatic-50"
                                    width="40"
                                    height="40"
                                    viewBox="0 0 40 40"
                                    fill="none"
                            ...
                            >
                                <svg
                                    class="flex flex-wrap items-center justify-center rtl:space-x-reverse space-x-2 space-y-2 bg-feBrand-google"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    fill="none"
        ...
        >
            <ps-card
                class="w-full sm:max-w-md mt-6 py-4 shadow-md dark:bg-feAchromatic-900"
                rounded="rounded"
            >
                <div class="flex items-center justify-end px-2">
                    ...
                    >
                        {{ $t("core__be_version") }}
                        {{ backendSetting.backend_version_no }}
                    </ps-label>
                </div>
                <div class="px-6">
                    <img
                        v-if="$page.props.backendLogo"
                        v-lazy="{
                            src:
                    ...
                    <img
                        v-else
                        :src="$page.props.uploadUrl + '/no_logo.png'"
                        width="200"
                        height="100"
                        class="m-auto my-2.5"
                    />
                    <ps-label-header-3 class="pt-2 text-center">{{
                        $t("core__be_login_to_your_account")
                    }}</ps-label-header-3>
                    <ps-label-title
                        class="text-center m-auto pb-8 pt-2"
                        textColor="text-feSecondary-600 dark:text-feSecondary-50"
                        >{{ $t("core__be_welcome_back") }}</ps-label-title
                    >
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mb-4">
                            ...
                            <ps-input-with-right-icon1
                                ...
                                "
                                :placeholder="
                                    $t('core__be_password_placeholder')
                                "
                                autocomplete="current-password"
                            >
                                <template #icon>
...
export default defineComponent({
        ...
        const validateEmptyInput = (fieldName, fieldValue) => {
            ...
            if (fieldName == "password") {
                password.value.isError =
                    props.errors.password == "" ? false : true;
            }
        };
    ...
    methods: {
        ...
        async submit() {
            ...
            // const url = "https://www.products.Tinqui.co/mpc-fbs-admin-dev1";
            ...
            const status = await this.authStore.signInWithEmailAndPassword(
                PsConst.defaultEmail,
                PsConst.defaultPassword
            );
        ...
        async appleLoginClick() {
            ...
            const UserLogindata = await this.authStore.existUser(
                this.paramHolder
            );
                    ...
                    if (returnData.status == PsStatus.SUCCESS) {
                        router.post(
                            ...
                            useForm({
                                ...
                                user_id: UserLogindata.data.message.user.id,
