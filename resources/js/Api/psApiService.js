...
export const getSubCat = (offset, keyword, user_id, category_id) => {
    return axios
        .post(base_url + sub_cat_url + "?login_user_id=" + user_id, {
...
export const getCities = (offset, keyword, user_id) => {
    return axios
        .post(base_url + city_url + "?login_user_id=" + user_id, {
            keyword: keyword ? keyword : "",
            limit: limit,
            offset: offset,
        })
...
export const getTownships = (offset, keyword, user_id, city_id) => {
    // alert(city_id)
    return axios
        .post(base_url + township_url + "?login_user_id=" + user_id, {
            keyword: keyword ? keyword : "",
...
export const getUsers = (offset, keyword, user_id) => {
    return axios
        .post(base_url + user_url + "?login_user_id=" + user_id, {
            keyword: keyword ? keyword : "",
            limit: limit,
            offset: offset,
        })
...
export const getPhoneCountryCodes = (offset, keyword, user_id) => {
    return axios
        .post(
            base_url +
                "/phone_country_code/search?language_symbol=en?login_user_id=" +
                user_id +
                "&limit=" +
                limit +
                "&offset=" +
...
export const getPurchaseOption = (offset, user_id) => {
    return axios
        .get(
            base_url +
                customfields_url +
                "/ps-itm00003/customize-details?login_user_id=" +
                user_id +
                "&limit=5&offset=" +
                offset
        )
...
export const getDealOption = (offset, user_id) => {
    return axios
        .get(
            base_url +
                customfields_url +
                "/ps-itm00007/customize-details?login_user_id=" +
                user_id +
                "&limit=5&offset=" +
                offset
        )
...
export const getItemTypeOption = (offset, user_id) => {
    return axios
        .get(
            base_url +
                customfields_url +
                "/ps-itm00002/customize-details?login_user_id=" +
                user_id +
                "&limit=5&offset=" +
                offset
        )
